	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Remove the steak from the refrigerator. Sprinkle it with 2 teaspoons salt, and let it stand at room temperature 45 for 60 minutes. Editor's Tip: The resting step here is essential for proper searing later! It also gives the meat time to absorb some of the salt."},
						{Text: "Preheat a cast-iron skillet over high heat until it's extremely hot, four to five minutes. Sprinkle the remaining 1 teaspoon salt in the bottom of the skillet. Editor's Tip: The high heat produces a lot of smoke, so make sure you're cooking in a well-ventilated space. It's also a good idea to turn on your kitchen vent or fan."},
						{Text: "Pat the steak dry with paper towels. Place the steak in the hot skillet. Cook until it can be easily moved, one to two minutes. Flip the steak, placing it in a different section of the skillet. Cook for 30 seconds, then begin moving the steak around the skillet, occasionally pressing on it slightly to ensure even contact with the skillet. Editor's Tip: Moving the steak around the hot skillet helps it get a better sear."},
						{Text: "Continue turning and flipping for one to two minutes, until the steak is cooked to the desired degree of doneness. A thermometer inserted in the thickest part of the meat should read: Medium-rare: 135° Medium: 140° Medium-well: 145° Editor's Tip: Keep in mind that the steak will continue to cook after it's removed from the skillet. It's best to aim for a few degrees shy of your desired temperature. Then let it rest for 10 minutes, and slice the steak against the grain."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Crumble Toppings: In a medium size bowl combine oats, flour, brown sugar, cinnamon, and baking powder. Add butter and cut in with a pastry blender or fork until well combined. Refrigerate while you prepare the apple filling."},
						{Text: "Apple Filling: (I use a Johnny Apple Peeler to peel, core and slice the apples all at once.) In a small bowl stir together melted butter and flour until smooth. Add lemon juice, milk and vanilla and stir. Stir in brown sugar, cinnamon, and nutmeg. Pour butter mixture over apples and toss to coat."},
						{Text: "Bake: Pour apple mixture into an 8x8-inch baking dish and spread into an even layer. Sprinkle crumble topping evenly over the apples. Bake for about 35 minutes or until golden brown and top is set. Remove from oven cool at least 15 minutes before serving."},
						{Text: "Serve with vanilla ice cream and homemade caramel sauce, if desired."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Place one of the pie crusts in the bottom of a greased 9” pie plate. Flute the edges. Chill the pie crust for 30 minutes."},
						{Text: "Preheat the oven to 375°F. Place parchment paper in the bottom of the pie crust, then fill with pie weights or dry beans. Blind bake the pie crust for 15 minutes or until the edges are starting to brown. Remove the crust from the oven and allow it to cool while you prepare the filling."},
						{Text: "In a large bowl, whisk the eggs. Then add the ham, ricotta, mozzarella, parmesan, oregano and garlic powder. Mix well."},
						{Text: "Pour the cheese and ham mixture into the baked bottom crust. Place the second pie crust on top and flute the edges to seal. (Set aside any excess pastry to make a cinnamon thing!)"},
						{Text: "Use a sharp knife to make 3 slits across the top of the pie crust. Sprinkle with sea salt and freshly ground pepper."},
						{Text: "Bake at 350°F for one hour."},
						{Text: "Store any leftover ham pie in the refrigerator in an airtight container or covered with plastic wrap."},
					},
				},
				Name: "Ham Pie",
				NutritionSchema: &models.NutritionSchema{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Place salmon in a sealable bag or medium bowl."},
						{Text: "In a small bowl or measuring cup, mix marinade ingredients."},
						{Text: "Pour half of the marinade on the salmon. Save the other half for later."},
						{Text: "Let the salmon marinate in the refrigerator for at least 30 minutes."},
						{Text: "In a medium pan, heat oil. Add salmon to the pan, but discard the used marinade. Cook salmon on one side for about 2-3 minutes, then flip over and cook for an additional 1-2 minutes."},
						{Text: "Remove salmon from pan. Pour in remaining marinade and reduce."},
						{Text: "Serve the salmon with sauce and a side of veggies. We used broccoli."},
						{Text: "Enjoy!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Melt the butter in a large skillet over medium heat. Add the garlic and cook until fragrant, about 1 minute, stirring constantly. Add in the shrimp and sprinkle with chili flakes and sea salt."},
						{Text: "Cook the shrimp for about 1 to 2 minutes per side, or until pink and opaque. Set aside on a plate."},
						{Text: "To the same skillet, add the lemon zest and juice. Pour in 5 cups of broth. Keep the remaining 1 cup on hand, in case you need it for later. Stir to combine then bring the liquid to a gentle simmer."},
						{Text: "Add the pasta, and using a pair of tongs, stir occasionally for a few minutes, or until the pasta starts to soften and bend. Fully immerse the pasta into the liquid, and keep stirring frequently to avoid sticking to the bottom of the pan."},
						{Text: "Cook the pasta according to the timing on the package directions. Angel hair pasta needs no more than 3 minutes to cook to al dente."},
						{Text: "Once the pasta is cooked to al dente, return the shrimp to the pan and turn the heat off. Stir in the Parmesan cheese and chopped parsley, and mix until the cheese has melted into the sauce. The pasta will continue to absorb the sauce if not served immediately. So quickly season with salt and pepper to your taste, and dig in!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to gas 3, 160 ̊C, fan 140 ̊C. Use a small sharp knife to pierce holes about 4cm deep all over the lamb, then season well with sea salt. In a small bowl, combine the chopped rosemary and garlic with 6 tbsp olive oil."},
						...
						{Text: "Roast for 1 hr 45 mins. Mix the honey with &frac14; tsp flaky sea salt and dab all over the lamb with a pastry brush. Return to the oven, increase the temperature to gas 7, 220 ̊C, fan 200 ̊C, then roast for a final 15 mins. Transfer the lamb to a warmed plate, then set aside to rest, covered loosely with foil, for at least 20 mins. Keep the veg warm while the lamb rests."},
						{Text: "Meanwhile, make the mint sauce. Finely chop the mint leaves with the sugar (this helps to stop oxidisation), then mix well in a bowl with 3 tbsp boiling water and the vinegar. Serve alongside the roast lamb, potatoes and carrots."},
					},
				},
				PrepTime:  "PT1H0M",
				TotalTime: "PT3H0M",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat your oven to 300˚ F (150˚ C). Grab (2x) rimmed baking sheets."},
						{Text: "Cut the bread into small cubes, including the crust, about 1-inch in size."},
						{Text: "Add the cubes to a food processor or high-powdered blender (you will need to work in batches). Process until fine crumbs form. Note: if you cannot get the crumbs small enough at this stage, you can process them again after baking."},
						{Text: "Divide the crumbs over the (2x) sheet pans in one even layer."},
						{Text: "Bake for 15-30 minutes, stirring once, or until the crumbs are crispy. Bake time will vary depending on bread type and freshness."},
						{Text: "Remove the breadcrumbs from the oven. Allow to cool."},
						{Text: "At this point, you can either keep the breadcrumbs plain or season, Italian-style (my preference). Add the dried garlic, onion, salt, oregano, parsley and cheese; mix well."},
						{Text: "Portion the cooled breadcrumbs into containers or a zip-top bag and freeze until ready to use."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Remove any fat and silver-skin from the roast, brush with mustard and season well with the rub"},
						{Text: "Put on a rack covered baking sheet, and cook 15 minutes, turn down to 325 and continue to cook until 125 internally - remove and let cool"},
						{Text: "When it's cool, wrap tightly in saran, and refrigerate overnight"},
						{Text: "When ready to build, preheat oven to 350"},
						{Text: "Slice buns horizontally, butter a 9x13 baking dish and put bottoms side by side in the pan"},
						{Text: "Spread mayo and mustard across all the bottoms, top with half cheese"},
						{Text: "Remove refrigerated roast, unwrap, dry off and slice into the thinnest slices possible - you'll need between 1 and 1.25 pounds"},
						{Text: "Top cheese with roast, add another layer of cheese, then the top buns"},
						{Text: "Combine butter, horseradish, garlic, Cholula, Worcestershire, parsley, soy & olive oil - mix well to combine, then brush about half over the little sandos"},
						{Text: "Cover with foil, and bake 20 minutes"},
						{Text: "Remove foil, brush again and bake another 7-10 or until the cheese is bubbly"},
						{Text: "Remove, let cool slightly and away you go."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Slice the avocados into small cubes in a mixing bowl, and mash them with a fork."},
						{Text: "Add fresh lime juice and mix in the avocados."},
						{Text: "Add sliced tomatoes, garlic, onion, and cilantro. Continue mashing with a fork."},
						{Text: "Add salt and black pepper to taste."},
						{Text: "Serve with sliced veggies, tortilla chips, or fajitas."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 180°C fan/200°C/gas 6. Put the butter and garlic into a roasting tin and pop into the oven to melt while you get on with slicing the leeks."},
						{Text: "Mix the sliced leeks with the melted garlic butter, season well with the sea salt and black pepper, then return to the oven to roast for 20 minutes."},
						{Text: "After 20 minutes, stir through the Puy lentils, crème fraîche and another good scatter of sea salt, then top with the feta cheese and breadcrumbs. Drizzle with the olive oil, then return to the oven for a further 20–25 minutes, until golden brown on top."},
						{Text: "Serve the gratin hot, with a mustard or balsamic dressed green salad alongside."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a large serving bowl place the cooked pasta, then pour one cup of the dressing on top. Stir to coat the pasta."},
						{Text: "Add in the cooked bacon, romaine lettuce, two types of tomatoes, the two types of cheese, the red onion, and the avocados."},
						{Text: "Pour the remaining half a cup of dressing over, then gently mix until the other ingredients are slightly coated. Taste test, and add more dressing if desired."},
						{Text: "Garnish with the fresh parsley and serve."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Heat the oven to 350°F. Arrange a rack in the middle of the oven and heat to 350°F."},
						{Text: "Slice the turkey and spread into a baking dish. Uniform slices or bite-sized pieces reheat quickly and evenly, so slice the turkey as needed. Place the turkey in a a single layer in an 8x8-inch baking dish."},
						{Text: "Cover the turkey with broth and dot with the butter. Add the broth and dot the turkey with the pieces of butter. Cover the baking dish with aluminum foil."},
						{Text: "Reheat in the oven for 30 to 35 minutes. Bake until the turkey is heated through, 30 to 35 minutes. Remember that all leftovers should be reheated to a minimum of 165°F."},
						{Text: "Serving. Uncover and serve the turkey immediately."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Season the chuck roast on both sides with salt and pepper. You can use more or less depending on your preferences."},
						{Text: "Heat the vegetable oil in a cast iron skillet or large pan over medium-high heat. Sear the chuck roast until browned on all sides, about 3-4 minutes per side. Remove the roast from the skillet and set aside."},
						{Text: "In a large mixing bowl, whisk together the apple cider, beef broth, Worcestershire sauce, minced garlic, tomato paste, dijon mustard, chopped rosemary, and chopped thyme. Whisk until thoroughly combined and set aside."},
						{Text: "Place the baby carrots and baby potatoes in the bottom of a slow cooker."},
						{Text: "Carefully transfer the seared chuck roast onto the bed of vegetables in the slow cooker."},
						{Text: "Pour the apple cider mixture over the roast and vegetables in the slow cooker."},
						{Text: "Cover the slow cooker and cook on LOW heat for 8-10 hours or on HIGH heat for 5-6 hours, until the meat is tender and easily shreds with a fork."},
						{Text: "Once cooked, remove the chuck roast from the slow cooker and let it rest for a few minutes before slicing or shredding it."},
						{Text: "Serve the pot roast with the cooked baby carrots, potatoes and a ladle of the flavorful cooking liquid, Garnish with fresh thyme, parsley and rosemary sprigs. Enjoy!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a large bowl whisk the apple sauce, cashew butter and egg until fully combined."},
						{Text: "Then add in the almond flour, tapioca flour, baking powder, sea salt, and cinnamon. Combine with a mixing spoon until a thick batter forms. It will be thick but still moist!"},
						{Text: "Heat ghee or butter in a pan over medium heat. Once the pan is hot, scoop the batter using a cookie scoop or about 1/4 cup full of batter. I like to cook 3 at a time."},
						{Text: "Place some blueberries onto the pancakes while on pan and cook for about 3 minutes. Flip gently, and continue cooking for about 2 minutes over medium-low heat."},
						{Text: "Repeat with remaining batter then serve with maple syrup, extra butter and toppings of choice. I love coconut cream or cashew butter!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Cut open the dried chiles with kitchen scissors or a knife and discard the seeds"},
						{Text: "Heat a large dry skillet over medium-high heat"},
						{Text: "Toast the chiles, moving them occasionally, for 4 minutes"},
						{Text: "(See Note)Cover the chiles with 2 inches of water"},
						{Text: "Bring the water to a boil over high heat, then turn the heat off and let the chilis soak until softened, about 15 minutes.Add chilies and garlic along with 1 ½ cups of the cooking liquid to a high speed blender and blend until smooth"},
						{Text: "Make the seasoned cabbage"},
						{Text: "In a medium bowl, combine cabbage, olive oil, vinegar, salt, and pepper and toss until combined.Heat the oil in a medium pot over medium heat"},
						{Text: "Once the oil is glistening, add the onions and cook until translucent, 4-5 minutes"},
						{Text: "To the same pot over medium heat, add the blended chilis, chicken stock, cumin, oregano, bay leaves and salt"},
						{Text: "Increase the heat to high and bring to a simmer"},
						{Text: "Cook for 30 minutes"},
						{Text: "Stir in the hominy and the turkey and continue to cook until the turkey is warmed through and the hominy has absorbed the broth, 20 minutes more"},
						{Text: "Taste and adjust season with salt.Serve the pozole in bowls topped with seasoned cabbage, avocado, cilantro, radishes, and lime juice."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Begin by making the cinnamon cookies. Add the softened butter, brown sugar, and white sugar to a bowl. Use a stand mixer or hand mixer to mix for 3-4 minutes, until well combined."},
						{Text: "Scrape down the sides and add the egg, egg yolk, and vanilla. Mix until well combined."},
						{Text: "Add the flour, cornstarch, cinnamon, baking soda, and salt. Mix on low until just combined. Add the white chocolate chips and pulse until well distributed."},
						{Text: "Set the dough aside and start on the streusel. For the streusel add the softened butter, brown sugar, cinnamon toast crunch, flour, cinnamon, and salt in a bowl. Use a stand mixer or hand mixer to mix until the streusel is well combined. The streusel should stick together when you squeeze it in your fist, but crumble when you run it through your fingers."},
						{Text: "Add 1/4 cup of cinnamon toast crunch to a blender. Blend until its fine crumbs. Pour the crumbs into a bowl."},
						{Text: "Use a large cookie scoop (about 1/4 cup) to scoop out the cinnamon dough. Roll the dough in your hands into a ball, then drop it into the bowl of cinnamon toast crunch crumbs. Roll the dough ball around in the crumbs until it is coated all over."},
						{Text: "Use a spoon or the back side of the cookie scoop to make an indent in the top of the dough ball. Add about 2 tbsp of streusel on top of the dough ball, in the indent. Repeat this process with the remaining dough."},
						{Text: "Add up to 6 dough balls on a parchment lined baking sheet then transfer to the oven. Bake for 8-9 minutes. Let the cookies cool on the baking sheet for 10 minutes, then transfer to a cooling rack to cool completely."},
						{Text: "While the cookies are cooling, make the icing. Add the powdered sugar, milk, and vanilla extract to a bowl. Whisk until smooth. When the cookies are cool, drizzle icing on top of each one and enjoy!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a large skillet heat the olive oil to medium high heat."},
						{Text: "In a medium bowl, add the avocado and mash to desired consistency. Add the onion, tomato, cilantro, garlic powder, lime juice and salt and pepper to taste."},
						{Text: "To make the egg rolls: Place the avocado mixture in the center of each wrapper. Using your finger, rub the edges with water. Bring the bottom edge of the wrapper and roll it tightly over the filling. Fold in the sides and continue to roll up the wrapper and press to seal. Repeat until you have used all of the wrappers."},
						{Text: "Add the. egg rolls to the hot oil and fry until they are golden brown on all sides for about 2-3 minutes. Remove with a metal tong onto a paper towel lined plate. Serve immediately with favorite dipping sauce."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Bring a large pot of well salted water to a boil. While the water is heating, remove the crusts from the bread, if you like, and tear or cut it into cubes."},
						{Text: "Put bread cubes, garlic, and 1/4 teaspoon of kosher salt in a food processor and pulse to make coarse breadcrumbs. You should have about 2 cups of crumbs, a bit more if the crusts are not removed."},
						{Text: "Heat the 3 tablespoons of the oil in a large Dutch oven or other heavy-duty pot over medium heat. When the oil shimmers, add the breadcrumbs. Cook, stirring frequently, until the crumbs are lightly brown and crisp, about 5 to 12 minutes, depending on the moisture in the bread."},
						{Text: "Transfer the breadcrumbs to a bowl, toss with lemon zest, if using, and set aside."},
						{Text: "Meanwhile, cook the pasta according to al dente according to package instructions, reserving 1/2 cup of the pasta water. Drain the pasta and set aside."},
						{Text: "Wipe out the pot used for the breadcrumbs. Add 3 tablespoons of the oil over medium heat until it shimmers. Add the halved garlic cloves and cook until lightly brown, about 2 minutes."},
						{Text: "Remove and discard the garlic pieces. Add the anchovies and crushed red pepper to the garlic-flavored oil and cook for 1 minute longer. Add the lemon juice, if using."},
						{Text: "Add the pasta to the pot and toss, cooking, until warmed through. Add some cooking water to loosen the mixture as needed. Taste and adjust the seasonings with salt and more crushed red pepper flakes, if desired."},
						{Text: "Plate the pasta in wide, shallow pasta bowls and top with a generous amount of garlic breadcrumbs. Garnish with chopped parsley and Parmesan cheese, if using. Serve with lemon wedges, if desired."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat oven to 400 degrees and line a baking sheet with foil."},
						{Text: "Remove the woody ends of the asparagus and toss the spears with olive oil, then sprinkle with the sea salt and pepper. Spread the asparagus spears out onto the prepared baking sheet and roast for 8-10 minutes or until slightly brown."},
						{Text: "Meanwhile, slice the cheese and butter the bread. Remove asparagus from oven."},
						{Text: "Heat up a large skillet over medium heat. Add two slices of the bread, butter side down, to the pan. Add cheese then add 3 spears of asparagus to each sandwich. Top with the other bread slices, butter side up."},
						{Text: "Toast for 3-4 minutes then flip and toast for 2 minutes. Remove from heat and serve hot with tomato soup!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Start by making the filling. Simply combine the ground pork, chopped scallions, sesame oil, soy sauce, wine (or sherry), sugar, oil, water, and white pepper in a bowl. Whip everything together by hand for 5 minutes or in a food processor for 1 minute. You want the pork to look a bit like a paste."},
						{Text: "To make the wontons, take a wrapper, and add about a teaspoon of filling. Overstuffed wontons will pop open during the cooking process and make a mess. Use your finger to coat the edges with a little water (this helps the two sides seal together)."},
						{Text: "For shape #1:"},
						{Text: "Fold the wrapper in half into a rectangle, and press the two sides together so you get a firm seal. Hold the bottom two corners of the little rectangle you just made, and bring the two corners together, pressing firmly to seal. (Use a little water to make sure it sticks.)"},
						{Text: "Shape #2:"},
						{Text: "Fold the wonton in half so you have a triangle shape. Bring together the two outer corners, and press to seal (you can use a little water to make sure it sticks)."},
						{Text: "Keep assembling until all the filling is gone (this recipe should make between 40 and 50 wontons). Place the wontons on a baking sheet or plate lined with parchment paper to prevent sticking."},
						{Text: "At this point, you can cover the wontons with plastic wrap, put the baking sheet/plate into the freezer, and transfer them to Ziploc bags once they’re frozen. They’ll keep for a couple months in the freezer and be ready for the fryer whenever you’re ready."},
						{Text: "To conserve oil, use a small pot to fry the wontons. Fill it with 2 to 3 inches of oil, making sure the pot is deep enough so the oil does not overflow when adding the wontons. Heat the oil to 350 degrees, and fry in small batches, turning the wontons occasionally until they are golden brown."},
						{Text: "If you have a small spider strainer or slotted spoon, you can use it to keep the wontons submerged when frying. This method will give you the most uniform golden brown look without the fuss of turning them. Remove the fried wontons to a sheet pan lined with paper towels or a metal cooling rack to drain."},
						{Text: "To make one or all of the sauces, simply mix the respective ingredients in a small bowl, and you’re ready to eat!"},
					},
				},
				Name: "Fried Wontons",
				NutritionSchema: &models.NutritionSchema{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In the Instant Pot, whisk together a cup of milk and 2 tablespoons of Greek yogurt until well combined. Then whisk in the rest of the milk. This makes it easier to thoroughly combine the yogurt and milk."},
						{Text: "Close the Instant Pot lid and press the \"Yogurt\" button, then press \"+\" to adjust the time. The incubation period for Greek yogurt is between 10-12 hours. Choose 10 hours for a mildly tangy yogurt. Increase the time for a tangier flavored yogurt.The Instant Pot will beep and then the timer will start counting up. Do not remove the lid or stir during the incubation period."},
						{Text: "After incubation, remove the lid check to make sure your yogurt has set, and taste your yogurt. If it is not tangy enough incubate it for another hour. Your yogurt will be thick, but not yet Greek yogurt consistency."},
						{Text: "Now, it is time to cool and strain the yogurt. To strain place a colander into a mixing bowl and line it with a cheesecloth or coffee filters. Pour the yogurt into the colander and place the whole thing into the refrigerator. Let the yogurt cool and strain for 2-4 hours. The longer it strains the thicker the yogurt will be."},
						{Text: "When the yogurt reaches your desired thickness store the yogurt in an airtight container in the refrigerator for up to 2 weeks. Reserve a portion of the yogurt to use as a starter for your next batch of yogurt."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Spray a large casserole dish with cooking spray (or grease with butter) and set aside."},
						{Text: "Boil potatoes until tender but still firm (about 15 minutes). Drain and drain the potatoes and put them back in the pot without a lid. Set them back on a hot/warm burner for a few minutes, shaking the pot, until all the excess moisture on the potatoes has evaporated."},
						{Text: "In a large mixing bowl, mix potatoes, cream cheese, milk, 1/4 cup (4 tablespoons) softened butter, and salt. Mix until blended."},
						{Text: "Add mashed potatoes to the prepared casserole dish and cover. Store in the refrigerator overnight or for up to two days."},
						{Text: "When ready to bake, let the potatoes sit at room temperature for about 1/2 hour and heat the oven to 350° F. Dot the top of the potatoes with the remaining 1/4 cup (4 tablespoons) of butter. Bake covered in the preheated oven for 30 minutes, uncover and bake until hot about another 15-20 minutes. This will give the mashed potatoes a bit of a crispy top."},
						{Text: "Garnish with freshly chopped chives or thyme, if desired."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "To make this easy recipe, take a pan and add water, boil the egg with a dash of salt. Once done, remove the shell and save for garnishing. In the meantime, wash and chop the beetroot and make a smooth blend."},
						{Text: "Next, whisk the curd and add beetroot blend along with spices, chopped coriander leaves and mix it well. Garnish with oregano and egg and enjoy."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Kok ris etter anvisningen på pakken."},
						{Text: "Del kylling i biter. Brun kyllingen i smør i en stekepanne på middels varme."},
						{Text: "Rens og hakk paprika, chili, vårløk og hvitløk og ha det i stekepannen sammen med kyllingen. Rens og finhakk ingefær og frisk koriander. Krydre med garam masala, koriander og ingefær."},
						{Text: "Hell i crème fraîche og tomatpuré, og la småkoke i 5 minutter. Smak til med salt og pepper."},
						{Text: "Riv agurk og bland den med yoghurt. Hakk mynte og hvitløk og bland det i. Smak til med salt og pepper."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Em uma vasilha junte à carne, o pacote de creme de cebola e amasse bem até ficar homogêneo."},
						{Text: "Em seguida sobre um plástico abra a massa (carne moida com o creme de cebola) no tamanho do tabuleiro que irá assar."},
						{Text: "Sobre a massa coloque a cebola e o alho picados bem pequenos, a mussarela em seguida o presunto."},
						{Text: "Para enrolar a massa basta começar a levantar a ponta do plástico."},
						{Text: "Sobre o rocambole já enrolado coloque as fatias de bacon para decorar."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Place the chickpeas in a large bowl and mash with a fork or potato masher until most of the chickpeas are smashed. Stir in the celery, onion, and pickles."},
						{Text: "In a small bowl, whisk together the Greek yogurt, lemon juice, mustard, red wine vinegar, dill, parsley, garlic powder, salt, and pepper."},
						{Text: "Add the sauce to the chickpea mixture and stir until well combined. Taste and adjust ingredients, if necessary."},
						{Text: "Serve in between two slices of bread to make a sandwich, in pita bread, in a lettuce wrap, in a tortilla, with crackers or chips, or on top of a rice cake, or add to a bed of greens to make a salad! The options are endless."},
					},
				},
