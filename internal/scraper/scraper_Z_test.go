			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Type: "HowToStep", Text: "Liberally season the short ribs with salt and pepper &#8211; ideally a day in advance and refrigerated, but if not, up to two hours at room temperature."},
						{Type: "HowToStep", Text: "Turn your Instant Pot on Sauté (high, if it's an option). Once it reads HOT, add the oil. Brown the short ribs in batches, until well browned on the meaty side (you don't need to brown them on all sides)"},
						{Type: "HowToStep", Text: "Remove the short ribs to a plate and add the onions. Sauté for 5-6 minutes, until browned and softened."},
						{Type: "HowToStep", Text: "Add the garlic and saut\u00e9 for another minute, until fragrant."},
						{Type: "HowToStep", Text: "Add the balsamic vinegar, tamari, honey, mustard, broth, and thyme. Once it starts to bubble, add the short ribs back in, meaty side down."},
						{Type: "HowToStep", Text: "Hit Cancel on the Instant Pot. Lock on the lid, making sure the seal is in place. Set to cook for 40 minutes at high pressure, making sure the valve is set to sealing."},
						{Type: "HowToStep", Text: "When the time is up, release the pressure and remove the lid once it unlocks. Remove the ribs to a platter and turn the Instant Pot back to Saut\u00e9. Reduce the sauce until it's about 3 cups in volume."},
						{Type: "HowToStep", Text: "Pour the sauce over the ribs. Pour over the lemon juice and sprinkle with lemon zest and parsley."},
						{Type: "HowToStep", Text: "Serve over polenta, mashed potatoes, or whatever you'd like."}},
				},
