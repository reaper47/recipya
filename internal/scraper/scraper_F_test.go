			...
			want: models.RecipeSchema{
				...
				Instructions: models.Instructions{
					Values: []string{
						...
						"In de tussentijd verhit je een koekenpan en bak je de groenteballetjes rondom bruin aan. Schep uit de pan en houd warm onder aluminiumfolie.",
						"Smelt een kwart van de boter in de pan en fruit hier 2 minuten de sjalot in.",
						"Voeg de rest van de boter toe en laat op laag vuur smelten. Roer nu de bloem erdoor en blijf een paar minuten roeren totdat je bloem ‘gebakken’ is. Deze roux is de basis voor je vegetarische jus. Schenk nu langzaam de warme bouillon erbij en klop met een garde totdat je een jus hebt die je qua dikte zelf goed vindt. Je kunt altijd nog wat extra bouillon toevoegen. Breng op smaak met sojasaus.",
						"Serveer de rode kool stamppot met groente gehaktballetjes, jus en garneer met fijngehakte peterselie. Eet smakelijk!",
					},
				},
