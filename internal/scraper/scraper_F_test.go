	...
	testcases := []testcase{
		{
			...
			want: models.RecipeSchema{
				...
				URL:          "https://www.familyfoodonthetable.com/slow-cooker-honey-garlic-chicken/",
				Video: &models.Videos{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Description: &models.Description{
					Value: "Orecchiette Broccoli Sauce (pasta con broccoli) a simple vegetarian pasta dish hailing from Tuscany that is easy to make, healthy and oh so delicious!",
				},
				Keywords: &models.Keywords{Values: "broccoli recipes, best pasta recipes, pasta con broccoli,broccoli pasta recipe, Orecchiette Pasta, Orecchiette recipes, Orecchiette, broccoli pasta, broccoli pasta recipes, orecchiette pasta recipe, broccoli recipes, vegetarian pasta recipes, healthy pasta recipes, vegetarian broccoli pasta"},
				Image:    &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						...
						{Type: "HowToStep", Text: "Stir in the lemon zest and pecorino cheese. Continue simmering gently on low heat until half of the liquid evaporates and it becomes the consistency of a thick sauce, about 10 minutes."},
						{Type: "HowToStep", Text: "Use an immersion blender right in the saucepan and add a small handful of chopped baby spinach and blend until smooth. Using the full 3 tablespoons of olive oil will help make the sauce &#8220;creamy&#8221;. (Alternatively, place the sauce in a blender with spinach)."},
						{Type: "HowToStep", Text: "Combine. Add the pasta to the sauce and add more hot pasta water as needed to keep it &#8221; saucy.&#8221;"},
						{Type: "HowToStep", Text: "Taste once more for salt, adjust, adding more along with pepper, chili flakes. If you want more richness add another splash of olive oil (or pat of butter- my husband loves this) or more pecorino if you like."},
						{Type: "HowToStep", Text: "Divide among pasta bowls and top with any of the garnishes you like!"},
					},
				},
				Name: "Orecchiette Broccoli Recipe",
				NutritionSchema: &models.NutritionSchema{
					Calories:      "351",
					Carbohydrates: "49.2",
					Cholesterol:   "9.7",
				...
				Video: &models.Videos{
					Values: []models.VideoObject{
						{
							AtType:       "VideoObject",
							ContentURL:   "https://content.jwplatform.com/videos/mXhs2DnA.mp4",
							Description:  "A simple delicious vegetarian recipe for Orecchiette Pasta with Broccoli Sauce – full of flavor and nutrients! ",
							Name:         "Orecchiette Pasta with Broccoli Sauce ",
							ThumbnailURL: &models.ThumbnailURL{Value: "https://content.jwplatform.com/thumbs/mXhs2DnA-720.jpg"},
							UploadDate:   time.Date(2019, 7, 17, 23, 37, 19, 0, time.UTC),
						},
					},
				},
			},
		...
		},
		{
			...
			in:   "https://www.finedininglovers.com/explore/recipes/mom-dukes-shrimp-kwame-onwuachi",
			want: models.RecipeSchema{
				AtContext: atContext,
				AtType:    &models.SchemaType{Value: "Recipe"},
				...
				CookTime:      "PT30S",
				Cuisine:       &models.Cuisine{Value: "Creole"},
				DatePublished: "2024-11-17T11:33:06-0500",
				Description: &models.Description{
					Value: "Delicious and juicy shrimp served with perfectly fluffy rice and a rich sauce, what could be better?",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
						...
						"Abita lager or Blue Moon beer : 3 oz/89ml",
						"Orange juice: 3 oz/89ml",
						"Dried oregano: 1 tsp",
						"Fresh bay leaf: 1",
						"Dry white wine, such as pinot grigio : 3 oz/89ml",
						"Fresh thyme: 3 sprigs",
						"Seafood or shrimp stock : 3 oz/89ml",
						"Worcestershire sauce: 5 tsp",
						"House spice blend (or your favorite Cajun seasoning) : 1 tbsp",
						"Neutral oil: For cooking",
						"Jasmine rice: 1 cup/250g",
						"FOR THE PERFECT STEAMED RICE",
						"Chicken stock: 1⅔ cups/393ml",
						"Thyme: 3 sprigs",
						"Kosher salt plus more to taste: 1 ½ tsp",
						"FOR THE FINISHED DISH",
						"Gulf shrimp (U-12 size), head-on (deveined with tails on) : 10 large",
						"Cold, cubed butter : 8 tbsp",
						"Lemon: 1",
			...
			want: models.RecipeSchema{
				...
				Video: &models.Videos{
					Values: []models.VideoObject{
						{
							AtType:       "VideoObject",
							ContentURL:   "https://content.jwplatform.com/videos/HzwLU00f.mp4",
							Description:  "Air fryer homemade breakfast sausage is so easy to make, you may never buy store-bought again. This healthy sausage recipe is low-carb, paleo, and whole30 compliant. The best part – it cooks in under 15 minutes!",
							Name:         "Air Fryer Homemade Breakfast Sausage",
							ThumbnailURL: &models.ThumbnailURL{Value: "https://content.jwplatform.com/thumbs/HzwLU00f-720.jpg"},
							UploadDate:   time.Date(2021, 8, 31, 22, 53, 37, 0, time.UTC),
						},
					},
				},
			},
