	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 350°F (180°C) and line a baking sheet with parchment paper."},
						{Text: "Add the oil to a large pot and turn heat to medium. Finely chop the mushrooms until they’re roughly the size of peas. Add chopped mushrooms to the pot along with minced garlic and a pinch of salt. Stir until combined. Sauté for about 6 to 8 minutes, until the water from the mushrooms cooks off, reducing heat to low if necessary to prevent burning."},
						{Text: "Meanwhile, tear the kale into large pieces and place into a food processor. Pulse (do not process) the kale until finely chopped (pieces roughly the size of almonds), being careful not to overprocess it. Remove and place into a bowl for later."},
						{Text: "To the processor (no need to clean it out!), add the rolled oats. Process the oats until they’re finely chopped and resemble coarse flour, about 30 seconds."},
						{Text: "Add the drained lentils and walnuts to the processor bowl with the oat flour. Pulse the mixture, stopping to check on it every few pulses, until it’s coarsely chopped. Be sure not to overprocess it into a paste as you still want a lot of texture and crunchy walnut pieces. Set aside."},
						{Text: "To the pot with the mushrooms and garlic, add the herbs and sauté for 30 seconds until fragrant. Stir in the kale and chopped dried cranberries, then turn off the heat."},
						{Text: "Stir the flax and water together in a small cup (no need to let it sit)."},
						{Text: "Now add all of the food processor contents, vinegar, and flax mixture to the pot. Stir until thoroughly combined. The dough should be heavy and dense. Add salt and pepper to taste."},
						{Text: "With lightly wet hands, shape and roll about 14 to 15 balls, roughly 3 to 4 tablespoons of dough each. Place them on the prepared baking sheet about two inches apart."},
						{Text: "Bake for 22 to 24 minutes, until golden on the bottom and firm to touch. Remove and let cool for 5 minutes."},
						{Text: "While the Bread-Free Stuffing Balls are baking, make the Cranberry-Pear Sauce. Add the cranberries, pear, maple syrup, and salt to a medium pot. Bring to a low boil over high heat and then reduce to medium. Simmer uncovered for 10 to 20 minutes until thickened. Use a potato masher to mash up the pear near the end of cooking, if desired."},
						{Text: "Leftover balls can be refrigerated in an airtight container for a few days. To reheat, add oil to a skillet and fry over medium heat, tossing occasionally, until heated through."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Combine the olive oil, vinegar, mustard, honey, Italian seasoning, salt, and pepper in a jar and shake until creamy.\u00a0"},
						{Text: "Place the chicken breasts in a bowl or zip-loc resealable bag, add half (about ⅓ cup) of the marinade, cover (or seal), and refrigerate for at least 30 minutes and up to 4 hours."},
						{Text: "Separately, in a small bowl, mix together the mayonnaise, blue cheese, mustard, garlic, and chives. Season to taste with salt and pepper.\u00a0"},
						{Text: "Heat a grill or grill pan over high heat. Remove the chicken from the marinade, shake off any excess, and season with more salt and pepper. Grill the chicken until done and grill marks form, 2–3 minutes per side.\u00a0"},
						{Text: "Brush both sides of the rolls with some of the remaining dressing and grill, face down, until toasted, 1–2 minutes. Spread the blue cheese mayonnaise on both sides of the rolls. Working with the bottom bun, layer on a piece of lettuce, chicken, bacon, some tomato slices, red onion, avocado slices, and a sliced hard-boiled egg. Drizzle some more dressing on the toppings. Close the sandwiches and enjoy!"},
					},
				},
