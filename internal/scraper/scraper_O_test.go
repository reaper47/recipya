	...
	testcases := []testcase{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				DatePublished: "2013-12-05T16:29:22+00:00",
				Description: &models.Description{
					Value: "Learn how to cook fragrant basmati rice to perfection—tender, fluffy, and just right for soaking up your favorite curries and more.",
				},
				Keywords: &models.Keywords{Values: "basmati rice"},
				Image:    &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
			...
			want: models.RecipeSchema{
				...
				Video: &models.Videos{
					Values: []models.VideoObject{
						{
							AtType:       "VideoObject",
							ContentURL:   "https://content.jwplatform.com/videos/ujQfgYd7.mp4",
							...
							ThumbnailURL: &models.ThumbnailURL{Value: "https://content.jwplatform.com/thumbs/ujQfgYd7-720.jpg"},
							UploadDate:   time.Date(2021, 7, 28, 0, 0, 0, 0, time.UTC),
						},
					},
				},
			},
