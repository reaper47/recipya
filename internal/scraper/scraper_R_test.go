	...
	testcases := []testcase{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Keywords: &models.Keywords{
					Values: "receita com frutos do mar,receita com peixe,receita sem crustaceos,receita sem carne de porco,receita sem peixe,MyMenuPlan,leite moça,pavê,Family Meals,Café da Tarde,Sobremesa,Local,New Years,Natal,Sem peixe,Sem crustáceos,Pouco sal,Sem carne de porco,Pescador,Under 300 kcal,De outros,Fruta,Frio / montagem",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Keywords:        &models.Keywords{Values: "Einfach, Europäisch, europaisch, Spanisch, Vorspeise, Braten, Snack"},
				NutritionSchema: &models.NutritionSchema{},
				PrepTime:        "PT20M",
				ThumbnailURL:    &models.ThumbnailURL{},
				Tools: &models.Tools{
