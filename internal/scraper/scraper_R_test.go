	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Prepare the rice per package but do a mix of the broth and water (optimal flavor!)"},
						{Text: "While the rice cooks, remove stems from the kale and chop the kale"},
						{Text: "Add kale to a large mixing bowl and massage with your hands with olive oil to cut the bitterness"},
						{Text: "Warm a large skillet with oil, garlic and onion and cook for 3-5 minutes or until fragrant"},
						{Text: "Add in the rice and press down to form a large &#8220;rice pancake&#8221; of sorts"},
						{Text: "Cook on medium heat for about 8 minutes then start to stir it to crisp the other side of the rice (do not cover the rice or it won't crisp!)"},
						{Text: "Remove rice from pan once crisped and add to mixing bowl with the kale and add in the edamame, scallions, peppers, kimchi, peanuts and mix"},
						{Text: "Dress with coconut aminos and sesame oil and salt and pepper and enjoy!"},
						{Text: "You can also add some cooked salmon, chicken or any additional protein if you'd like"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Heat the olive oil in a Dutch oven over medium heat. Once the oil is hot, add the onion, and season with a pinch or two of salt and pepper. Cook for 7 to 8 minutes, until golden, stirring occasionally. Add in the carrot, celery, and garlic, with another pinch of salt and cook for 3 to 4 minutes. Add the red pepper flakes, parsley, and sage and cook until fragrant, about 1 minute."},
						{Text: "Add the tomato paste and cook, stirring almost continuously, for 1 to 2 minutes, until it&#39;s a bit darker in color."},
						{Text: "Pour the white wine in and deglaze the pan, scraping up any browned bits stuck to the bottom of the pot. Allow wine to simmer rapidly for 3 minutes, or until mostly evaporated and it no longer smells like wine, stirring often."},
						{Text: "Add tomatoes along with their juices, bay leaf, 1 teaspoon kosher salt, and several cracks of black pepper. Cook at a rapid simmer, stirring fairly often, until the tomatoes are fully broken down and most of the liquid has evaporated, 12 to 13 minutes."},
						{Text: "Add the veggie broth and 2 cans of beans. Reduce the heat to low, cover the pan, and maintain a decent simmer for 30 minutes, stirring once in a while. If you want the stew to be thicker, towards the end of cooking, use the back of a wooden spoon or a spatula to gently smash a small portion of the beans."},
						{Text: "Taste, adding a pinch of sugar if needed (if your tomatoes are good-quality, it should not be necessary). Remove the bay leaf. Finish with chopped basil. Season to taste, adding salt and pepper as needed."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat oven to 450°F. Arrange the chicken and sweet potatoes side by side in a single layer on a large rimmed baking sheet. Season with the sage, salt, and pepper and drizzle with 2 tablespoons of the oil, tossing to coat. Lay the bacon on top of the sweet potatoes."},
						{Text: "Roast until a meat thermometer inserted into the thickest portion of a thigh registers 165°F, 20 to 25 minutes."},
						{Text: "Meanwhile, toss together the watercress, lemon juice, and the remaining 1 tablespoon of olive oil and season to taste with salt and pepper."},
						{Text: "Serve the chicken with the sweet potatoes and salad, with the bacon crumbled over the top."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Em uma panela, misture o Leite MOÇA, o Leite NINHO, as gemas e o amido de milho e leve ao fogo, mexendo sempre até engrossar. Deixe esfriar e reserve."},
						{Text: "Passe rapidamente parte dos biscoitos na calda do pêssego, acomodando-os no fundo de um refratário retangular (20 x 30 cm)."},
						{Text: "Distribua metade do Creme e metade dos pêssegos picados."},
						{Text: "Repita a camada de biscoitos e coloque o restante do Creme e dos pêssegos."},
						{Text: "Decore com as raspas de Chocolate GALAK e com fatias de pêssegos."},
						{Text: "Leve à geladeira até o momento de servir."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Faites cuire les nouilles dans de l’eau bouillante en les gardant fermes. Égouttez-les."},
						{Text: "Préparez la sauce : mettez les ingrédients de la sauce dans une petite casserole et chauffez jusqu’à ce que le sucre soit dissous."},
						{Text: "Faites chauffer l’huile de sésame et 1 cuillerée d’huile de pépins de raisin dans un wok. Faites-y revenir le porc jusqu’à ce qu’il soit légèrement doré. Réservez."},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Combine all of the ingredients in a saucepan and bring to a boil over medium-high heat. Once boiling, reduce the heat to a simmer."},
						{Text: "Stir occasionally and cook until the cranberries have broken down and the apples have softened, but still have a little bite to them, about 10-15 minutes. The sauce should be compote-like in consistency."},
						{Text: "Remove the cranberry apple sauce from the heat and let it cool completely before transferring it to a bowl to chill in the refrigerator until ready to eat."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Marinade chicken - Combine the marinade ingredients in a large ziplock bag. Add the chicken, seal, the massage from the outside with your hands to make sure each piece is coated. Marinate 24 hours (minimum 3 hours)."},
						{Text: "Yogurt Sauce - Combine the Yogurt Sauce ingredients in a bowl and mix. Cover and put in the fridge until required (it will last for 3 days in the fridge)."},
						{Text: "Preheat stove or BBQ - Heat a large non-stick skillet with 1 tablespoon over medium high heat, or lightly brush a BBQ hotplate/grills with oil and heat to medium high. (See notes for baking)"},
						{Text: "Cook chicken - Place chicken in the skillet or on the grill and cook the first side for 4 to 5 minutes until nicely charred. Turn and cook the other side for 3 to 4 minutes (the 2nd side takes less time)."},
						{Text: "Rest - Remove chicken from the grill and cover loosely with foil. Set aside to rest for 5 minutes."},
						{Text: "Slice chicken and pile onto platter alongside flatbreads, Salad and the Yoghurt Sauce (or dairy free Tahini sauce from this recipe)."},
						{Text: "To make a wrap, get a piece of flatbread and smear with Yoghurt Sauce. Top with a bit of lettuce and tomato and Chicken Shawarma. Roll up and enjoy!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Cook linguine until al dente per package directions (usually around 7-8 minutes)."},
						{Text: "In a large skillet pan-fry the garlic, chilli, and parsley in 2 tbsp of oil over high heat for 5 minutes."},
						{Text: "Add the prawns and stir for 2 minutes. Add the butter and let foam for an additional minute."},
						{Text: "Add the strained pasta noodles along with lemon juice, zest, remaining oil and white wine. Season to taste with salt and pepper."},
						{Text: "Stir to combine then serve immediately in bowls topped with parmesan cheese."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a small bowl, mix oyster sauce, light soy sauce, dark soy sauce and white pepper. Set aside."},
						{Text: "Heat an empty, well-seasoned wok over high heat until smoking hot. Add 1 tablespoon of oil (see note 3 if using other cookware). Swirl to coat a bigger perimeter."},
						{Text: "Pour in the beaten egg. Once it begins to set at the bottom, stir to help the running part flow. Use a spatula to scramble so that it turns into small pieces. Transfer out and set aside."},
						{Text: "Pour the remaining 1 tablespoon of oil into the wok. Add minced pork. Spread and flatten it to ensure maximum contact with the wok. Wait for the bottom part to get lightly browned. Then flip and stir to fry it thoroughly."},
						{Text: "Once the pork loses its pink colour, add onion, garlic and ginger. Fry until the onion becomes a little transparent."},
						{Text: "Stir in peas and carrots. Retain the high heat to fry for 30 seconds or so. Add rice and return the egg to the wok. Cook for a further 30-40 seconds."},
						{Text: "Pour the sauce mixture over. Toss and stir constantly to ensure an even coating. Once all the ingredients are piping hot, turn off the heat. Sprinkle scallions over and give everything a final toss."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Den Knoblauch und den Ingwer mit einer feinen Küchenreibe in eine große Schüssel reiben. \nDie zwei Schalotten in grobe Scheiben schneiden und die Chilischoten in der Mitte teilen, nun kann man die Kerne entfernen."},
						{Text: "Die gehackten Zutaten kommen zu den Übrigen in die Schüssel. Anschließend den Saft einer Limette, 250 Gramm Joghurt, einen guten Schuss Olivenöl sowie die Gewürzmischung samt Salz und Pfeffer dazu. \nAlles zusammen mit dem Hühnchen vermengen und dieses mindestens eine halbe Stunde in den Kühlschrank stellen."},
						{Text: "Als Nächstes die marinierten Stücke der Brust aus der Schüssel nehmen und diese auf Spieße stecken. Den Grill auf direkte, starke Hitze vorheizen und die Spieße direkt über die Glut legen, um Sie von allen Seiten anzugrillen. \nSind die Spieße scharf angegrillt (Ihr könnt die Stücke auch in der Pfanne braten), diese vom Grill nehmen und sie kurz bei Seite legen."},
						{Text: "In der Zwischenzeit kann man eine Pfanne auf den Grill stellen und dort die Butter, eine grob gehackte Schalotte, das Tomatenmark sowie den Rest der Marinade hineingeben. \nAlles zusammen wird unter direkter starker Hitze angebraten und anschließend mit 500 ml Wasser aufgegossen."},
						{Text: "Ist alles etwas eingekocht gebt Ihr die Hähnchenstücke und Euren Becher Creme Fraiche dazu. \nNun wird die Pfanne in den indirekten Bereich gestellt und alles wird etwa 20-25 Minuten bei geschlossenem Deckel geschmort."},
						{Text: "Der Reis wird zusammen mit der Gewürzpaste in einen Topf gegeben, anschließend kommt die 1,5 Fache Menge an Wasser dazu (im Zweifel mit Tassen abmessen). \nNun lasst Ihr den Reis zusammen mit dem Wasser und der Gewürzmischung etwa 10 Minuten quellen ehe Ihr Ihn auf den Herd oder die Seitenkochplatte stellt."},
						{Text: "Den Reis kurz aufkochen, die Flamme zurückstellen und den Reis unter gelegentlichem Rühren garen lassen. Wenn das Wasser verschwunden ist, ist er fertig.\nJetzt kann man die Rosinen und die Cashewkerne dazu geben und den Reis eventuell mit noch etwas Gewürzpaste und Salz abschmecken."},
						{Text: "Für den Minzjoghurt die übrigen 250 Gramm Joghurt nehmen und in eine Schüssel geben. \nDie Gurke in der Mitte durchschneiden und das Kerngehäuse entfernen. Anschließend in feine Würfel schneiden. Die Minze in feine Streifen schneiden und zusammen mit den Gurkenwürfeln zum Joghurt geben. Mit Salz und Pfeffer abschmecken."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Hähnchenfleisch, Salz, Knoblauch in den Mixtopf geben und 5 Sek./Stufe 7 zerkleinern."},
						{Text: "Brot in Stücken mit Frischkäse und Milch zugeben und 10 Sek./Stufe 7 vermischen."},
						{Text: "Fleischmischung aus dem Mixtopf nehmen, walnussgroße Bällchen formen und leicht mit dem Boden des Messbechers flach drücken. Jedes Nugget zuerst in Ei und dann in Paniermehl wenden. Öl in einer tiefen Pfanne erhitzen. Nuggets darin goldbraun frittieren und auf Küchenkrepp abtropfen lassen."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Mettere nel boccale la scorza di limone e le mandorle: 10 sec. vel. 10."},
						{Text: "Raccogliere sul fondo e aggiungere la farina, il lievito, lo zucchero e il burro a tocchetti: 40 sec. vel. 5."},
						{Text: "Aggiungere l'uovo e 40 g di succo di limone: 30 sec. vel. 5."},
						{Text: "Versare la frolla in una ciotola, coprire con pellicola e trasferire in frigorifero per 25 minuti."},
						{Text: "Con l'aiuto di 2 cucchiaini prelevare piccole quantità di frolla (morbida), farle cadere in un piatto con dello zucchero a velo e rotolarle fino a ricoprirle completamente."},
						{Text: "Disporre le palline su una teglia rivestita di carta forno."},
						{Text: "Infornare in forno preriscaldato statico a 180° per 10 minuti."},
						{Text: "Sfornare, lasciare raffreddare e servire."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 325F°. Grease and line the cake pans."},
						{Text: "In a small bowl, whisk together the flour, baking powder and salt."},
						{Text: "In a medium bowl using hand mixer, cream together the butter, sugar and extracts until light and fluffy, 6 to 8 minutes."},
						{Text: "Add the egg whites to the butter mixture, mix until combined (do not over mix)."},
						{Text: "Alternate adding the flour mixture and milk in three addition, starting and ending with the flour. Do not over mix."},
						{Text: "Pour batter evenly into prepared pans. Bake for 30 minutes or until toothpick comes out clean."},
						{Text: "In a large bowl, crumble the cakes and add the buttercream.Mix with the hand mixer until a smooth dough forms. It should feel like cookie dough."},
						{Text: "Separate the cake dough evenly between 6 bowls. Add and mix the colors red, orange, yellow, green, blue and purple into each bowl until desired colors - about 1/2 teaspoons to 1 teaspoon per bowl."},
						{Text: "Split all the colored dough into 1/2 teaspoon pieces. Stack 6 pieces of each color starting with the red and ending with the purple and roll into a smooth ball. Repeat with the rest of the dough (about 40 balls). Chill in refrigerator for 1 hour."},
						{Text: "Melt the white Candy Melts in the melting pot. Dip each cake ball in the candy and sprinkle the rainbow sprinkles on top."},
					},
				},
				Name:  "Rainbow Treats",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Ben je aan het bakken geslagen met Oreo’s en zoek je een bijpassende vulling of topping? Deze crème is perfect als Oreo cupcake topping of als toppin"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Pre-heat oven to 180 degrees C.  Grease and line a 20 cm round cake pan (I used a silicone ring tin)Mix dates and bi-carb soda in boiling water and leave to soak for a few minutes while you do the next step."},
						{Text: "Grind almonds for 10 seconds, speed 9.Set aside."},
						{Text: "Put dates, water and bi-carb into mixing bowl, and blend for 30 seconds, speed 6.  You may need to stop and scrape the sides a couple of times, and maybe reduce the speed a little after the first few seconds if necessary.   "},
						{Text: "Add eggs, oil, vanilla essence and blend for 20 seconds, speed 6.  Scrape down bowl."},
						{Text: "Add almonds, baking powder, cocoa and salt and mix for 20 seconds, speed 6.  Scrape down bowl and repeat. "},
						{Text: "Pour into prepared cake tin and bake at 180 degrees for 30 minutes, or until a skewer comes out clean.  Leave until cool before turning onto a serving plate. I covered mine with chocolate ganache and served with whipped cream and raspberry coulis.  "},
					},
				},
				PrepTime: "PT10M",
				CookTime: "PT40M",
