...
func TestScraper_S(t *testing.T) {
	testcases := []testcase{
		...
		{
			name: "saltandlavender.com",
			in:   "https://www.saltandlavender.com/creamy-garlic-chicken/",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtType:        &models.SchemaType{Value: "Recipe"},
				...
				Description: &models.Description{
					Value: "This creamy garlic chicken recipe is the ultimate easy comfort food! Tender chicken breasts smothered in a creamy garlic sauce are irresistible. Garlic lovers unite!",
				},
				Keywords: &models.Keywords{Values: "creamy garlic chicken recipe"},
				Image:    &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Text: "Cut the chicken in half lengthwise so you have 4 smaller cutlets. Generously season them with salt &amp; pepper and coat them in the flour.", Type: "HowToStep"},
						{Text: "Add the olive oil and 1 tbsp of the butter to a skillet over medium-high heat. Once the pan is hot, sauté the chicken for 4-5 minutes/side or until it's nice and golden. Take the chicken out of the pan and set it aside.", Type: "HowToStep"},
						{Text: "Reduce the heat to medium (or even med-low if using cast iron), and add the rest of the butter to the pan. Let it melt and then add the garlic cloves. Cook them for 3-4 minutes, stirring often, until they're lightly browned on the outside.", Type: "HowToStep"},
						{Text: "Add the chicken broth, lemon juice, and garlic powder to the pan. Let it bubble for around 4 minutes or until the liquid is noticeably reduced.", Type: "HowToStep"},
						{Text: "Stir in the cream and add the chicken back into the pan. Let it cook for another 5 minutes or so, until the sauce is reduced and the chicken is cooked through. Serve with freshly chopped parsley if you wish.", Type: "HowToStep"},
					},
				},
		...
		{
			name: "seriouseats2.com",
			in:   "https://www.seriouseats.com/the-best-buffalo-wings-oven-fried-wings-recipe",
			want: models.RecipeSchema{
				AtContext:     atContext,
				AtType:        &models.SchemaType{Value: "Recipe"},
				Category:      &models.Category{Value: "uncategorized"},
				...
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{},
				Description:   &models.Description{Value: "This oven-fried crispy buffalo wing recipe makes baked wings that are less messy than their fried counterpart, and taste almost indistinguishable."},
				Keywords:      &models.Keywords{Values: "Chicken Wings,North American,Gluten-free Snacks & Appetizers,Savory,Snacks & Appetizers"},
				Image:         &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{Values: []string{
				...
				Instructions: &models.Instructions{Values: []models.HowToItem{
					{Type: "HowToStep", Text: "Line a rimmed baking sheet with aluminum foil and set a wire rack inside. Carefully dry chicken wings with paper towels. In a large bowl, combine wings with baking powder and salt and toss until thoroughly and evenly coated. Place on rack, leaving a slight space between each wing. Repeat with remaining 2 batches of wings."},
					{Type: "HowToStep", Text: "Place baking sheet with wings in refrigerator and allow to rest, uncovered, at least 8 hours and up to 24 hours."},
					{Type: "HowToStep", Text: "Adjust oven rack to upper-middle position and preheat oven to 450°F (230°C). Add chicken wings and cook for 20 minutes. Flip wings and continue to cook until crisp and golden brown, 15 to 30 minutes longer, flipping a few more times towards the end."},
					{Type: "HowToStep", Text: "Meanwhile, combine butter and hot sauce in a small saucepan and cook over medium heat, whisking until combined. Transfer wings to a large bowl, add sauce, and toss to thoroughly coat. Serve wings immediately with blue cheese dressing and celery sticks, conspicuously shunning anyone who says that real Buffalo wings must be fried."},
				}},
				Name: "The Best Oven-Fried Chicken Wings",
				NutritionSchema: &models.NutritionSchema{
					Calories:      "458",
					Carbohydrates: "6",
					Cholesterol:   "85",
				...
				Tools: &models.Tools{
					Values: []models.HowToItem{
						{Type: "HowToTool", Quantity: 1, Text: "Rimmed baking sheet"},
						{Type: "HowToTool", Quantity: 1, Text: "wire cooling rack"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				CookTime:      "PT10M",
				Cuisine:       &models.Cuisine{Value: "American"},
				DatePublished: "2022-03-02T10:00:00+00:00",
				Description: &models.Description{
				...
				Keywords: &models.Keywords{
					Values: "dairy free dill pickle pasta salad, dairy free macaroni salad, dairy free pasta salad, dill pasta salad, dill pickle pasta salad, pasta salad recipe, pasta salad with pickles",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
			...
			want: models.RecipeSchema{
				...
				Ingredients: &models.Ingredients{
					Values: []string{
						...
						"1/2 can(s) diced tomatoes", "1/6 can(s) black beans",
