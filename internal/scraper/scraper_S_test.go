	...
	testcases := []testcase{
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{Values: []models.HowToStep{
					{Text: "Em uma tigela grande, coloque o pão, a água e o Tempero SAZÓN®, e, com o auxílio de um garfo, amasse até o pão desmanchar completamente e formar uma massa homogênea. Acrescente o ovo e o queijo ralado, e misture."},
					{Text: "Espalhe a massa em uma assadeira redonda (30 cm de diâmetro), untada e enfarinhada, e leve ao forno médio (180 graus), preaquecido, por 15 minutos, ou até estar assada e desgrudar do fundo da assadeira."},
					{Text: "Retire do forno, espalhe a polpa de tomate pela superfície, por cima a muçarela, as rodelas de tomate e as azeitonas, e volte ao forno médio (180 graus), por mais 10 minutos, ou até o queijo derreter completamente. Retire do forno e sirva em seguida."},
				}},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Place the whole unpeeled potatoes in a 4-quart saucepan and cover with a few inches of cold water."},
						{Text: "Bring to a simmer and cook until they are very tender when pierced with a paring knife, about 25 to 35 minutes depending on the size of the potatoes."},
						{Text: "Strain the cooked potatoes in a colander and carefully peel with a clean kitchen towel and a paring knife. Work quickly so the potatoes stay warm."},
						{Text: "Push the potatoes through a potato ricer or food mill back into the warm pot they were cooked in."},
						{Text: "Add the room temperature butter and combine using a stiff spatula. Next start adding 3/4 cup of the hot cream and gently fold in. Add more as needed."},
						{Text: "Season well with kosher salt and freshly ground pepper. Taste and add more butter, cream or seasoning as needed."},
						{Text: "Cover and keep warm until serving with another pat of butter and fresh herbs if desired."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a medium bowl, cover seaweed with at least 3 inches cold water and let stand at room temperature until fully softened and hydrated, about 2 hours."},
						{Text: "Meanwhile, in a Dutch oven or pot, combine whole garlic cloves, ginger, onion, and brisket with 1 1/2 quarts (1 1/2L) cold water and bring to a boil over high heat. Lower heat to maintain a gentle simmer and cook, covered, until brisket is tender and broth is slightly cloudy, about 2 hours. Using a slotted spoon, remove and discard garlic cloves, ginger, and onion from broth."},
						{Text: "Transfer brisket to a work surface and allow to cool slightly, then slice across the grain into bite-size pieces. Transfer brisket to a small bowl and toss well with 1 tablespoon soy sauce and remaining 3 cloves minced garlic. Set aside."},
						{Text: "Drain seaweed and squeeze well to remove excess water. Transfer to work surface and roughly chop into bite-size pieces."},
						{Text: "Return broth to a simmer and add seaweed and seasoned brisket. If the proportion of liquid to solids is too low for your taste, you can top up with water and return to a simmer. Add remaining 1 tablespoon soy sauce and simmer until seaweed is tender, about 30 minutes. Season to taste with salt."},
						{Text: "Ladle soup into bowls and serve alongside hot rice and any banchan (side dishes) of your choosing."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Batter: In a medium bowl, whisk together the flour, sugar, baking powder, and cinnamon. Be sure to warm your milk if using coconut oil before using or it will harden the coconut oil when combined. Add milk and mix well. Add oil/butter, mix well again."},
						{Text: "Assemble: Pour batter into an 8-inch baking dish. Drop blackberries into the batter, distributing evenly all over. Push down some of the blackberries into the batter, then add more over top. Sprinkle a little pure cane sugar over top if you like. I would refrain from using coconut sugar as it may burn. If you want to add coconut sugar, sprinkle some at least halfway through baking time."},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Heat the oil in a large skillet over medium heat. Add ginger and garlic and saute for 30 - 60 seconds until fragrant. Add the quinoa and kimchi and cook until hot, about 2 - 3 minutes. Stir in kimchi juice, tamari and hot sauce if using. Turn to low and stir occasionally while you prepare the other ingredients."},
						{Text: "In a separate skillet, cook the eggs on low until the whites have cooked through but the yolks are still runny, about 3 - 5 minutes."},
						{Text: "Steam the kale in a separate pot for 30 - 60 seconds until soft."},
						{Text: "Assemble the bowls, dividing the kimchi-quinoa mixture and kale evenly between two dishes. Top with green onions and fresh pepper if using."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Prepare the chicken: Trim chicken thighs of any extra fat. Chop into bite-sized pieces about 1/2 to 1-inch wide. Place the chicken thigh pieces to a medium bowl. Add the yogurt, ginger, garlic, cumin, paprika and salt. Using your hands, combine the chicken with the spices until the chicken is evenly coated."},
						{Text: "Marinate the chicken: Cover the bowl with plastic wrap and let the chicken marinate in the fridge for at least 45 minutes or as long as overnight. (Marinating for 4 to 6 hours is perfect.)"},
						{Text: "Cook the chicken: In a large skillet, heat 1 tablespoon of canola oil over medium-high heat. Add the chicken thigh pieces and cook for about 6 to 7 minutes, until they’re cooked through. Transfer to a plate and set aside."},
						{Text: "Toast the spices: Wipe down the pan you used to cook the chicken. Heat remaining canola oil over medium heat. Add the onions and cook for 5 minutes, until softened, stirring often. Add the grated ginger, minced garlic, coriander, paprika, garam masala, turmeric, black pepper, salt, and cayenne. Let the spices cook until fragrant, about 30 seconds to a minute."},
						{Text: "Make the sauce: Add the crushed tomatoes to the pan with the spices and let everything cook for 4 minutes, stirring often. Add the yogurt and stir to combine."},
						{Text: "Simmer the sauce: Reduce the heat to medium-low and let the sauce simmer for another 4 minutes. Add the chicken pieces to the pan and coat with sauce."},
						{Text: "Serve: Serve over cooked basmati rice and garnish with cilantro."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "If needed, cook pasta according to package directions for al dente in a large pot of salted, boiling water. Drain pasta and rinse with cold water."},
						{Text: "In a medium mixing bowl, whisk the mayonnaise, Dijon mustard, pickle juice, and water until smooth. Season salt &amp; pepper, to taste."},
						{Text: "Combine salad ingredients in a large mixing bowl, reserving about 1 teaspoon fresh dill. Add dressing and stir until evenly coated."},
						{Text: "Before serving, adjust seasoning with salt &amp; pepper (to taste) and garnish with remaining dill."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Combine the spices in a small bowl."},
						{Text: "Spray the steak with olive oil and coat both sides with the spices."},
						{Text: "Preheat the air fryer so the basket gets hot. For a 1-inch steak, air fry 400F 10 minutes turning halfway, for medium rare, for medium, cook 12 minutes, flipping halfway. See temp chart below, time may vary slightly with different air fryer models, and the thickness of the steaks."},
						{Text: "Finish with a pinch of more salt and black pepper."},
						{Text: "Let it rest, tented with foil 5 minutes before slicing."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Heat oven: To 350°F (175°C). Lightly coat an 8-inch square or 9-inch cake pan with butter or nonstick spray. For extra security, line it with parchment paper."},
						{Text: "Make crumbs: Whisk butter, sugars, cinnamon, and salt together until evenly mixed. Add flour and mix until it disappears. It’s going to be very thick; press it evenly into the bottom of the bowl and set it aside."},
						{Text: "Make cake: Beat butter with sugar until lightened and fluffy. Add egg, water or milk, sour cream, and vanilla and beat until combined. Sprinkle surface of batter with baking powder and salt, and beat well to combine. Add flour and mix only until it disappears."},
						{Text: "Assemble: Scrape batter into prepared cake pan and smooth it flat. Use a spoon to loosen the crumbs from the bottom of the bowl where they’ve rested, breaking them up into big and small rubble. Sprinkle evenly over the batter."},
						{Text: "Bake: Bake for about 30 to 35 minutes, or until a toothpick inserted into the cake just below the crumbs comes out batter-free. Check in a few spots, in case it has baked unevenly."},
						{Text: "Cool to lukewarm, if you can bear it, before dusting it generously with powdered sugar and cutting the cake into squares or wedges."},
						{Text: "Do ahead: This cake keeps in an airtight container at room temperature for 3 to 4 days, but I like it best in the first two."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Mix everything but the cabbage in a small bowl. In a larger one, toss the cabbage with as much dressing as you like. Adjust the salt and pepper to taste. Refrigerating a couple hours before serving allows the flavors to meld well, and the cabbage to soften slightly."},
					},
				},
				Name:  "slaw tartare",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Prick potatoes with a fork. Microwave, covered with a paper towel, on high power until tender, 10 to 12 minutes."},
						{Text: "Cutting lengthwise, remove top fourth of each potato and scoop out centers (reserve for another use), leaving 1/2-inch-thick walls."},
						{Text: "Whisk together mayonnaise, 1 tablespoon water, tomato paste, anchovy paste, and 1 1/2 tablespoons mustard."},
						{Text: "Preheat oven to 350°F with rack in middle."},
						{Text: "Cook onion in oil with a pinch of salt in a small heavy skillet over medium heat, stirring occasionally, until golden, about 10 minutes."},
						{Text: "Meanwhile, tear bread into small pieces, then soak in milk in a medium bowl until very soft. Mix in sausage, parsley, onion, and 2 tablespoons mayonnaise sauce with your hands."},
						{Text: "Divide filling between potatoes, then coat skins lightly with oil. Bake in a 4-sided sheet pan until sausage is cooked through, about 30 minutes."},
						{Text: "While potatoes bake, whisk 1 tablespoon mayonnaise sauce with lemon juice, remaining 1 1/2 teaspoon mustard and 1/2 teaspoon water, and salt and pepper to taste."},
						{Text: "Remove potatoes from oven and turn on broiler. Spoon remaining mayonnaise sauce over filling and broil 3 to 4 inches from heat until charred in spots, 3 to 5 minutes. Cool slightly."},
						{Text: "Toss greens with dressing and serve with potatoes."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Elősz&ouml;r k&eacute;sz&iacute;ts&uuml;k el a veg&aacute;n s&oacute;s karamellt az ebben a receptben le&iacute;rtak szerint. Haszn&aacute;ljunk fel belőle 150 ml-t, a marad&eacute;kb&oacute;l pedig k&eacute;sz&iacute;ts&uuml;nk karamelles latt&eacute;t, csurgassuk alm&aacute;s pite tetej&eacute;re, vagy fogyasszuk tetsz&eacute;s szerint. Ha elk&eacute;sz&uuml;lt, hagyjuk szobah\xc5\x91m&eacute;rs&eacute;kletűre hűlni."},
						{Text: "Egy t&aacute;lban habos&iacute;tsuk fel a n&ouml;v&eacute;nyi tejsz&iacute;nt, majd tegy&uuml;k f&eacute;lre. Tegy&uuml;k egy m&aacute;sik t&aacute;lba a veg&aacute;n kr&eacute;msajtot, &eacute;s a k&eacute;zi mixerrel ezt is habos&iacute;tsuk fel, majd adjuk hozz&aacute; a van&iacute;liakivonatot &eacute;s 100 ml-t a karamellből, &eacute;s dolgozzuk &ouml;ssze."},
						{Text: "Egy spatul&aacute;val &oacute;vatosan forgassuk bele a felhabos&iacute;tott tejsz&iacute;nt, majd osszuk a kr&eacute;met 4 egyforma poh&aacute;rba a k&ouml;vetkező m&oacute;don: kanalazzunk a poharak alj&aacute;ra 1-1 kan&aacute;llal a megmaradt karamellből, majd mehet r&aacute; a kr&eacute;m is."},
						{Text: "Fogyaszt&aacute;s előtt legal&aacute;bb 1 &oacute;r&aacute;ra tegy&uuml;k hűtőbe, hogy kiss&eacute; megdermedjen, &eacute;s az &iacute;zek &ouml;ssze&aacute;lljanak."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a medium cast-iron Dutch oven, melt butter over medium heat. Add celery, carrot, onion, garlic, and thyme; cook over medium heat, stirring occasionally, until vegetables are crisp-tender, about 10 minutes. Sprinkle flour over vegetables and cook, stirring, until evenly coated and lightly browned, about 3 minutes."},
						{Text: "Add rice and gradually stir in broth, salt, pepper, and poultry seasoning. Bring to a boil; reduce heat to low and simmer, stirring occasionally, until vegetables are tender, about 30 minutes."},
						{Text: "Add turkey; cook, stirring occasionally, until rice is tender, 10 to 15 minutes. Serve warm. Garnish with pepper and thyme, if desired."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Make butter mixture: Preheat oven to 425°F. Stir together butter, parsley, garlic, rosemary, thyme, salt, and pepper in a bowl until evenly combined."},
						{Text: "Spread butter on corn: Spread 1 tablespoon herb butter on each corn cob."},
						{Text: "Wrap corn in foil: Wrap each corn on the cob individually in aluminum foil."},
						{Text: "Roast corn in oven: Place foil-wrapped corn on a baking sheet. Bake in preheated oven until corn is soft, 20 to 25 minutes, turning once halfway through cook time. Remove corn from foil, and serve"},
					},
				},
				TotalTime: "PT30M",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Sort through the peas to ensure there is no debris. Rinse and drain well."},
						{Text: "In a large pot, combine peas, ham, water, broth, parsley, and bay leaf. Bring to a boil, reduce heat to low, and simmer covered for 1 hour."},
						{Text: "Add in celery, carrots, onion, pepper, thyme, and salt. Cover and simmer 45 minutes more."},
						{Text: "Remove ham bone and chop the meat. Return the meat to the soup and cook uncovered until thickened and the peas have broken down and the soup has thickened, about 20 minutes more."},
						{Text: "Discard the bay leaf and season with salt and additional pepper to taste."},
					},
				},
				Name: "Split Pea Soup",
				NutritionSchema: &models.NutritionSchema{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "You can get the recipe for homemade cornbread here."},
						{Text: "Preheat oven to 350 degrees."},
						{Text: "Heat a skillet on medium-high heat. When hot, add the olive oil, celery, onions, garlic, and green peppers."},
						{Text: "Saute until the onions are translucent, fragrant, and the vegetables are soft. Remove the vegetables from the pan. Set aside to cool while prepping the remaining ingredients."},
						{Text: "Place day old cornbread in a large mixing bowl. Use a large spoon and/or your hands to break down the cornbread. You want to fully crumble it."},
						{Text: "Add in the sauteed veggies, ground sage, Old Bay seasoning, salt, and pepper. Mix well. Stop and taste the mixture here. This is where you want to adjust the seasoning and spice if necessary to suit your taste. Before adding the eggs, taste the dressing."},
						{Text: "Add in the eggs and cream of chicken soup. Stir."},
						{Text: "Slowly pour in the chicken broth. Start with a little chicken broth and then stir until the dressing is thick. Add more when needed. You should get the consistency of thick oatmeal."},
						{Text: "Add in 1/2 of the dressing mixture and spread it throughout the bottom of the pan."},
						{Text: "Add the shrimp and crab on top."},
						{Text: "Top it with a layer of the remaining dressing."},
						{Text: "Bake for 40-45 minutes uncovered on 350 degrees until a toothpick returns clean."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Make the Quick Cucumber Pickle: Mix together all the Quick Pickle ingredients. You can make this a few hours in advance and store in refrigerator. The longer it sits, the less “crunch” you’ll have. I like making this cucumber pickle 1 hour prior, storing in refrigerator and serving it cold on the tacos for texture and temperature contrast."},
						{Text: "Make the Koji BBQ Sauce: Whisk all BBQ sauce ingredients together until sugar has dissolved and mixture is smooth. You can make this a few days in advance and store tightly covered in the refrigerator."},
						{Text: "Toss the Koji BBQ Sauce with your cooked pulled pork or shredded chicken. Warm the tortillas and serve tacos with the Quick Cucumber Pickle."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Note: a slow cooker is recommended for extra juicy chicken, but to save time, you can also cook the stew in a large pot on the stove and keep it at a simmer until the chicken breasts are fully cooked, about 10-15 minutes, before taking them out to shred."},
						{Text: "Place the chicken breasts into the bottom of a slow cooker, and pour tomatoes, green salsa, black beans, pinto beans, and corn over the chicken. Sprinkle taco seasoning, cayenne, cumin, and some salt over the mixture, and stir to combine. Cover the cooker, set on Low, and cook until chicken is very tender and the mixture has thickened, 8 to 10 hours."},
						{Text: "After its finished cooking, remove the chicken breasts and shred them with two forks. Return the shredded chicken to the stew and stir."},
						{Text: "Mix a few tablespoons of stew liquid with cream cheese in a bowl, stir until smooth, and mix the cream cheese into the cooker to make a creamy sauce. Continue to cook for 15 minutes, then serve."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Prep the milk-vinegar mixture"},
						{Text: "Prep the vegetables; make the dumpling dough"},
						{Text: "Prep and brown the chicken"},
						{Text: "Cook the vegetables"},
						{Text: "Finish the chicken; cook the dumplings"},
						{Text: "Serve"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Kog risen som anvist."},
						{Text: "Agurk-tomatsalat: vask og hak agurk og tomat i små fine tern. Vend dem sammen citronsaft og salt og peber."},
						{Text: "Rør ingredienserne sammen til dressingen og smag til."},
						{Text: "Peberfrugt skæres i grove strimler, rødløget skæres i tynde halve skiver, hæld vandet fra kikærterne."},
						{Text: "Opvarm lidt olie på en pande og rist først kikærterne sammen spidskommen og paprika samt salt og peber. Tag dem til side og rist peberfrugterne på begge sider så de tager farve."},
						{Text: "Steg kebaben som anvist på pakken."},
						{Text: "Anret shawarma bowlen med alle ingredienserne. Skal det være ekstra lækkert, kan jeg anbefale at lave syltet rødkålssalat til - det smager skønt."},
					},
				},
				Name: "Shawarma bowl",
				NutritionSchema: &models.NutritionSchema{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Drain and rinse beans; set aside. Drain chiles and reserve 1/2 cup of each soaking liquid; set aside."},
						{Text: "Heat a large pot over medium-low heat. Add oil, then onion, carrot, bell pepper, jalapeño, garlic, and 1/2 tsp. salt. Stir frequently on medium-low heat until liquid is released and vegetables start to stew down."},
						{Text: "Add the paprikas, chili powder, cayenne, cumin, black pepper, onion powder, tomato paste, beans, and tomatoes and stir to incorporate."},
						{Text: "In a medium bowl, use an immersion blender to purée the chiles, the reserved chile soaking liquids, 1 1/2 tbsp. vinegar, the chipotle in adobo, brown sugar, 1 1/2 tsp. salt, and 3 tbsp. water. Add mixture to pot, bring to a simmer, and simmer lightly for 1 1/2 hours."},
						{Text: "Add corn and 1/3 cup water to pot, bring back to a simmer, and let simmer lightly for 1 hour."},
						{Text: "Remove pot from heat. Stir in the chocolate, 1/2 tsp. salt, and the remaining 3 tbsp. vinegar. Serve warm, topped with garnishes, if using."},
					},
				},
				Name:      "Veggie Chili",
				PrepTime:  "PT0H0M",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat your oven to 425 and line a large baking sheet with foil (it will help keep the tomatoes from sticking to the pan)."},
						{Text: "Add the tomatoes and onion to the pan and drizzle over 1.5 tablespoons olive oil along with the balsamic vinegar. Sprinkle generously with salt and pepper and toss to combine."},
						{Text: "Slice the top off the head of garlic, making sure to leave it intact."},
						{Text: "Drizzle the remaining half tablespoon of olive oil over the garlic and wrap it tightly in foil."},
						{Text: "Place the garlic cut side up on the baking sheet."},
						{Text: "Roast for 35 minutes, or until the tomatoes are caramelized and the onions are golden brown."},
						{Text: "Remove the garlic from the foil and squeeze out the cloves-- be careful, it will be hot!"},
						{Text: "Add the garlic cloves to a food processor, along with the roasted tomatoes, roasted onion, remaining two tablespoons balsamic vinegar, and fresh basil."},
						{Text: "Puree to your desired consistency and season with salt and pepper to taste."},
						{Text: "Store the marinara sauce in an airtight container in the fridge for up to five days or in an airtight container in the freezer for up to three months."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Combine - In the base of a 6-quart slow cooker, place the chicken breasts, corn and onion slices."},
						{Text: "Blend sauce - Using a stand or immersion blender, blend the sauce ingredients and pour over slow cooker contents."},
						{Text: "Slow cook - Cover and cook on low for 4-5 hours, until chicken is cooked through."},
						{Text: "Serve - Shred chicken, then serve in tortillas topped with yogurt, shredded cabbage, and radish slices. * see note 3"},
					},
				},
