	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Put the noodle nest in a bowl and cover with boiling water. Let stand for 2 minutes, mix briefly and drain the water. Place 40g of prepared noodles in a soup bowl (one nest of lucky boat noodles will do about 4-5 takeaway sized portions of soup). Set aside."},
						{Text: "Put the light chicken stock, light soy sauce, sea salt, MSG and white pepper in a saucepan, bring to the boil then reduce to a simmer. Add the sliced chicken and simmer for about 3 minutes until the chicken is cooked through."},
						{Text: "Pour the chicken soup over the prepared noodles in the bowl. Garnish with the sliced spring onion, drizzle with sesame oil (if using) and serve."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 350°F. Lightly grease a 9” x 5” quick bread pan or 12” x 4” tea loaf pan."},
						{Text: ", In a large bowl, stir together the starter, sugar, honey, oil, eggs, nutmeg, lemon zest, and vanilla until thoroughly combined."},
						{Text: ", In a separate medium bowl, whisk together the flours, baking soda, baking powder, and salt; stir into the wet ingredients."},
						{Text: ", Stir in the grated zucchini, then the nuts and fruit. Transfer the batter to the prepared pan, smoothing the top."},
						{Text: ", Bake the bread in the 9” x 5” pan for 45 minutes. Tent with foil and bake for an additional 20 minutes, until a thin paring knife inserted in the center comes out clean. For bread in a tea loaf pan, bake for 40 minutes before tenting, then bake for another 20 minutes, or until the loaf tests done."},
						{Text: ", Remove the bread from the oven and cool in the pan on a rack."},
						{Text: ", Store bread, well wrapped, at room temperature for up to three days; freeze for longer storage."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Oliven abgießen. Cherrytomaten halbieren, Knoblauch hacken und Frühlingszwiebeln in feine Ringe schneiden. Zwiebel, Paprika, Zucchini und Aubergine in walnussgroße Stücke schneiden."},
						{Text: "Etwas Olivenöl in die Pfanne geben und Knoblauch, Zwiebel, Paprika, Zucchini und Aubergine bei mittlerer Hitze ca. 4 – 6 Min. anbraten."},
						{Text: "Reis in die Pfanne geben und gut umrühren. Für weitere 1 – 2 Min. anbraten."},
						{Text: "Zitronen filitieren."},
						{Text: "Safran in die Pfanne geben und gut umrühren, um alles zu vermengen. Für weitere 1 – 2 Min. braten."},
						{Text: "Mit Weißwein ablöschen. Gemüsebrühe hinzugeben, bis alle Zutaten mit Flüssigkeit bedeckt sind. Nach Geschmack mit Salz und Pfeffer würzen. Alles aufkochen lassen, dann auf ein Köcheln reduzieren und ca. 15 – 20 Min. köcheln lassen, bis der Reis bissfest ist. Gelegentlich umrühren."},
						{Text: "Vorsichtig die Zitronenfilets, Tomaten, Oliven, Frühlingszwiebeln und Erbsen unterheben. Für weitere 5 – 6 Min. braten. Genießen!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "für 2 Personen als Hauptspeise \r\nfür 4 Personen als Vorspeise"},
						{Text: "1. Spargel schälen und in 4-5 Stücke schneiden"},
						{Text: "3. Spargel inm Salzwasser und wenig Zucker bissfest Kochen. Wasser wegschütten"},
						{Text: "4. leicht abkühlen lassen und in der Zwischenzeit die Mango schälen und in kleine Würfel schneiden"},
						{Text: "Dressing"},
						{Text: "Saft von 1 Orange in eine Schüssel geben und das Olivenöl hinzufügen gut verrühren und mit Salz und Pfeffer abschmecken. Die Spargeln darin wenden und ein wenig ziehen lassen."},
						{Text: "Schön Anrichten und mit Lachs garnieren ANSTELLE Lachs passen auch wunderbar Crevetten dazu."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Arbeitszeit: ca. 1 Std. Ruhezeit: ca. 1 Tag\nSchwierigkeitsgrad: simpel\nKalorien p. P.: keine Angabe"},
						{Text: "Die Schokolade mit der Butter langsam schmelzen. Einen Teil der Mandeln mit unterheben, dann den Eierlikör unterrühren. Am besten über Nacht erkalten lassen."},
						{Text: "Mit Hilfe von einem Teelöffel kleine Mengen abstechen und zu Kugeln formen. Die Kugeln anschließend in den restlichen gemahlenen Mandeln wälzen und in Papierförmchen setzen. Kühl aufbewahren!"},
						{Text: "Das Rezept ergibt ca. 24 Pralinen."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Skala alla räkor och ställ åt sidan."},
						{Text: "Gör en majonnäs genom att lägga ner äggulor, senapen och vinägern i en bunke. Tillsätt matoljan i en tunn stråle medan du vispar hela tiden. Använd elvisp eller handvisp. När majonnäsen är tjock och du ser dragen/spåren av vispen i majonnäsen är den klar."},
						{Text: "Lägg alla räkor i en bunke, tillsätt fint plockad dill och blanda ner lite majonnäs i taget."},
						{Text: "Tillsätt lite riven pepparrot och smaka av. Slå på mer majonnäs för en rinnigare röra eller mer pepparrot för mer sting."},
						{Text: "Ta fram brödet och skär ut önskad form utan att ta med kanterna, använd en skål eller ett glas som mall om ni vill ha runda bröd. Stek sedan gyllene i smör."},
						{Text: "Lägg upp bröden på tallrik, toppa med skagenröra och en rejäl klick löjrom. Avsluta med en dillkvist och en citronskiva."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "All set?"},
						{Text: "Knead butter, flour, water, egg, and salt into a uniform dough."},
						{Text: "Wrap in cling film and refrigerate."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Ogórki umyć, osuszyć, obrać i pokroić w jak najcieńsze plasterki."},
						{Text: "Plasterki umieścić w misce i posypać 1 łyżeczką soli. Wymieszać i pozostawić na ok. 15 minut."},
						{Text: "W międzyczasie śmietanę przełożyć do miseczki. Przyprawić sokiem z cytryny, cukrem, pieprzem i posiekanym koperkiem. Wymieszać."},
						{Text: "Po 15 minutach odlać wodę, którą puściły ogórki. (Lekko je odcisnąć, ale nie za mocno, aby mizeria nie wyszła za sucha)."},
						{Text: "Dodać przygotowaną śmietanę i wymieszać."},
					},
				},
				Name:  "Mizeria",
				Yield: &models.Yield{Value: 4},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Postup"},
						{Text: "POTREBUJEME"},
						{Text: "Bravčové rolády"},
						{Text: "Bravčové karé prikryjeme fóliou a naklepeme na tenké plátky. Nožom narežeme okraje,"},
						{Text: "aby mäso počas opekania držalo svoj tvar. Ochutíme soľou a korením. Na každý plátok položíme plátok šunky, lístky šalvie a plátok syra. Zrolujeme a uzatvoríme pomocou špáradiel."},
						{Text: "Pripravené rolády obalíme v hladkej múke a opečieme na rozohriatom olivovom oleji"},
						{Text: "po celom obvode do zlatohneda. K výpeku pridáme lyžicu masla, lyžicu hladkej múky, podlejeme vínom a\u00a0trochou vody. Varíme, kým sa z vína odparí alkohol. Potom pridáme nadrobno nasekané lístky šalvie a dochutíme soľou a korením. Stiahneme z ohňa, prikryjeme pokrievkou a necháme chvíľu odpočívať."},
						{Text: "Zemiaková kaša"},
						{Text: "Umyté a očistené zemiaky nakrájame na menšie kúsky a uvaríme v osolenej vode domäkka. Potom ich scedíme. V kastróle zohrejeme mlieko spolu s maslom, ktoré postupne prilievame k uvareným"},
						{Text: "a scedeným zemiakom. Mixérom vymiešame hladkú kašu. Na záver dochutíme nadrobno nasekanou pažítkou."},
						{Text: "Servírovanie"},
						{Text: "Na tanier naservírujeme zemiakovú kašu a rolády nakrájané na kolieska. Pokvapkáme výpekom. Podávame spolu s rukolou, ktorú ochutíme soľou, korením, olivovým olejom a citrónovou šťavou."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Piekarnik nagrzać do 180 stopni C.\u00a0Masło roztopić i przestudzić. Czekoladę pokroić na kawałeczki."},
						{Text: "Mąkę przesiać do miski razem z proszkiem do pieczenia, sodą i kakao, dokładnie wymieszać. Dodać cukier oraz cukier wanilinowy i ponownie wymieszać."},
						{Text: "W drugiej misce rozmiksować jajka z mlekiem (rózgą lub mikserem)."},
						{Text: "Do sypkich składników dodać masę jajeczną i krótko zamieszać łyżką. Dodać roztopione masło i wymieszać do połączenia składników, pod koniec dodając 2/3 ilości dropsów czekoladowych."},
						{Text: "Masę wyłożyć do papilotek umieszczonych w formie na muffiny, na wierzch wyłożć po łyżeczce masła orzechowego na każdą muffinkę."},
						{Text: "Wykałaczką zrobić \"ósemkę\" w cieście mieszając delikatnie masę czekoladową z masłem orzechowym. Wierzch posypać pozostałą 1/3 dropsów czekoladowych."},
						{Text: "Wstawić do piekarnika (można piec na raty, w 2 partiach) i piec\u00a0przez około 20 -\u00a023 minuty, do suchego patyczka."},
					},
				},
