	...
	testcases := []testcase{
		{
			...
			want: models.RecipeSchema{
				...
				DatePublished: "2024-09-03T10:00:21+00:00",
			...
			want: models.RecipeSchema{
				...
				Ingredients: &models.Ingredients{
					Values: []string{
						...
						"2 garlic clove", "5.291 oz vegan chow mein noodles", "&#188; napa cabbage",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Description: &models.Description{
					Value: "This Cajun dirty rice with smoked sausage is loaded with flavor and makes the perfect Southern side dish or entree! Flavored with Cajun spices, the holy trinity, and spicy smoked sausage, this dirty rice is a real crowd-pleaser.",
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{},
				DateModified:  "2023-11-02T13:33:04.000Z",
				DatePublished: "2019-11-11T16:32:36.000Z",
				Description: &models.Description{
				...
				Keywords: &models.Keywords{
					Values: "popsugar uk, becky tarala, food, exclusive, christmas, autumn, recipes, carrots, side dishes, original recipes, fall recipes, fall food",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
				...
				Name: "Cinnamon Butter Baked Carrots",
				NutritionSchema: &models.NutritionSchema{
					Calories: "219",
				},
				ThumbnailURL: &models.ThumbnailURL{},
