	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Place the nuts in a food processor and pulse several times to “chop” them into a crumbly texture - a few larger pieces are a good thing - don’t overmix!"},
						{Text: "Transfer the nuts to a large mixing bowl and stir in coconut flakes and salt to evenly combine."},
						{Text: "Place the melted coconut oil in a medium bowl and whisk in the peanut butter and honey or maple syrup. Once mixture is smooth and well combined, stir in the vanilla."},
						{Text: "Pour the wet mixture into the large bowl with the dry ingredients and stir to fully combine - I used a silicone spatula for this step. Thoroughly mix to make sure all the dry mixture is coated. Once coated, gently stir in the chocolate chips."},
						{Text: "Line an 8 x 8” or 9 x 9” square pan with parchment paper along the bottom and sides, with extra up the sides for easy removal. Transfer mixture in and press down, using your hands, or another piece of parchment paper to get it packed tightly into the pan."},
						{Text: "Cover the top with parchment or plastic wrap, then set in the freezer for at least 1 hour to firm, or longer if you have time."},
						{Text: "Remove pan from freezer and grab two ends of the parchment paper to remove the bars, set on a cutting board."},
						{Text: "Using a long very sharp knife, cut into 15-20 bars. You can wrap them in parchment individually storing in the fridge (for up to two weeks) or freezer for longer."},
						{Text: "Bars will start to melt around room temp due to the coconut oil, so they’ll need to be kept chilled to stay firm. Enjoy!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Corte os filés de frango em cubos de 3 cm e transfira para uma tigela. Tempere com 1 colher (chá) de sal, o curry e pimenta a gosto e mantenha em temperatura ambiente enquanto prepara os outros ingredientes — assim ele absorve melhor o sabor do curry e perde o gelo antes de ir para a panela."},
						{Text: "Descasque e pique fino a cebola e os dentes de alho. Descasque e corte as maçãs em fatias de 1,5 cm; descarte o miolo com as sementes, corte as fatias em tiras e as tiras em cubos."},
						{Text: "Leve uma panela média ao fogo médio. Quando aquecer, regue com o azeite, adicione a cebola e tempere com uma pitada de sal. Refogue por cerca de 3 minutos, até murchar. Junte o alho e mexa bem por 1 minuto para perfumar."},
						{Text: "Acrescente os cubos de frango e refogue por cerca de 1 minuto, até perderem a aparência crua — evite refogar em excesso para que o frango não resseque; ele vai terminar de cozinhar com o restante dos ingredientes."},
						{Text: "Junte os cubos de maçã, regue com o creme de leite e misture bem. Assim que começar a ferver, abaixe o fogo e deixe cozinhar por cerca de 10 minutos, até que o frango e a maçã estejam cozidos e o molho levemente encorpado. Sirva a seguir com folhas de coentro a gosto."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Heat the oven to 400ºF."},
						{Text: "Combine all of the dry ingredients in a medium bowl. Beat the eggs, sugar, pumpkin, and oil until smooth. Pour the pumpkin mixture into the dry ingredients and mix just until blended."},
						{Text: "Grease a muffin tin or fill your tin with cupcake papers. Fill the wells with the batter until they are 2/3 of the way full. Bake for 16-20 minutes. Cool 5 minutes and then complete the cooling process on a wire rack."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: `Cube the bread into approximately 1" pieces and spread onto a lipped baking sheet. Bake in a 170°F preheated oven for 30-60 minutes, or until dry. Alternatively, you can cube the bread and let it sit out overnight to stale.`},
						{Text: "In a large mixing bowl, whisk together the eggs, milk, vanilla, and 1 teaspoon of the cinnamon."},
						{Text: "Add the stale cubed bread to the egg mixture and stir so all pieces of the bread are fully coated. Cover the bowl with plastic wrap and move it to the fridge for 4-8 hours."},
						{Text: "In a small mixing bowl, use a pastry cutter or a fork to cut together the butter, brown sugar, and remaining cinnamon. Cover and put in the fridge as well."},
						{Text: "When ready, spray a 6 quart slow cooker with non-stick spray and pour in the soaked bread pieces."},
						{Text: "Crumble the butter mixture evenly over the top."},
						{Text: "Cover and cook on HIGH for 2 hours or LOW for 4 hours, or until the center is set."},
						{Text: "Turn the slow cooker to WARM and remove the lid. Let stand for 15 minutes to set before serving."},
						{Text: "Top with powdered sugar, syrup, and berries."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 350 degrees. Microwave the butter for about 40 seconds to just barely melt it. It shouldn't be hot &#8211; but it should be almost entirely in liquid form."},
						{Text: "Using a stand mixer or electric beaters, beat the butter with the sugars until creamy. Add the vanilla and the egg; beat on low speed until just incorporated &#8211; 10-15 seconds or so (if you beat the egg for too long, the cookies will be stiff)."},
						{Text: "Add the flour, baking soda, and salt. Mix until crumbles form. Use your hands to press the crumbles together into a dough. It should form one large ball that is easy to handle (right at the stage between &#8220;wet&#8221; dough and &#8220;dry&#8221; dough). Add the chocolate chips and incorporate with your hands."},
						{Text: "Roll the dough into 12 large balls (or 9 for HUGELY awesome cookies) and place on a cookie sheet. Bake for 9-11 minutes until the cookies look puffy and dry and just barely golden. Warning, friends: DO NOT OVERBAKE. This advice is probably written on every cookie recipe everywhere, but this is essential for keeping the cookies soft. Take them out even if they look like they're not done yet (see picture in the post). They'll be pale and puffy."},
						{Text: "Let them cool on the pan for a good 30 minutes or so (I mean, okay, eat four or five but then let the rest of them cool). They will sink down and turn into these dense, buttery, soft cookies that are the best in all the land. These should stay soft for many days if kept in an airtight container. I also like to freeze them."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Corte dois alhos a meio e dois em quatro, eliminando as folhas."},
						{Text: "Coloque-os num tabuleiro e regue com o azeite. Tempere com flor de sal, pimenta e tomilho. Leve ao forno por 20 minutos ou até ficarem dourados."},
						{Text: "Numa frigideira de ferro ou que possa ir ao forno, adicione o vinagre e deixe cozinhar cerca de 1 minuto ou até reduzir."},
						{Text: "Junte a manteiga, o açúcar e mais um pouco de tomilho. Cozinhe durante cerca de 2 minutos."},
						{Text: "Retire os alhos do forno e coloque-os na frigideira alinhados sobre o molho de manteiga. Tente ao máximo que fiquem apertadinhos."},
						{Text: "Pincele-os com mostarda, polvilhe com o parmesão e cubra com a massa folhada. Empurre as bordas da massa para dentro."},
						{Text: "Leve ao forno por 35 minutos ou até a massa estar dourada."},
						{Text: "Retire do forno, deixe que arrefeça ligeiramente e vire para um prato."},
						{Text: "Sirva ainda quente."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Cook the rice in 2 cups of chicken stock until tender according to package instructions. Fluff the rice with a fork and set aside."},
						{Text: "In a medium heavy-bottomed skillet over medium-high heat, melt butter with the olive oil. Add the smoked sausage to the skillet and cook until the sausage is browned, about 3-5 minutes."},
						{Text: "Add the onion, bell pepper, and celery and cook until the veggies begin to soften, about 2-3 minutes. Add the garlic and cook until fragrant, about another minute."},
						{Text: "Season the sausage and vegetables with garlic powder, onion powder, smoked paprika, dried thyme, dried oregano, salt, black pepper, and cayenne pepper and stir with a wooden spoon."},
						{Text: "Add a little bit of chicken stock to the skillet to deglaze the pan, scraping up any brown bits with the wooden spoon. Add the cooked rice to the skillet and stir to combine the rice with the veggies and sausage. Continue to cook while stirring for another 2 to 3 minutes. Add a little more chicken stock if needed so that the rice isn't dry."},
						{Text: "Remove the pan from the heat and transfer the rice to a serving dish. Garnish with fresh chopped parsley if desired. Enjoy!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Ingredients: &models.Ingredients{
					...
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 425° F. Remove the Puff Pastry Dough from the fridge at let sit at room temp."},
						{Text: "Meanwhile, heat olive oil in a pan to medium heat. Add onions and saute until fragrant and slightly translucent, about 5 minutes. Add the mushrooms, salt, and pepper. Cook stirring occasionally until the mushrooms are browned and have released liquids, then the liquid evaporates, about 8 minutes."},
						{Text: "Stir in garlic and thyme and cook 2 minutes more. Remove the pan from the heat."},
						{Text: "Unroll the puff pastry sheet on a baking sheet, keeping the parchment on the bottom to prevent sticking. Score the edges using a sharp knife, leaving a 1-inch border. Then use a fork to prick the center puff pastry sheet every 2 to 3 inches."},
						{Text: "Top the puff pastry with grated cheese, leaving the 1-inch border of dough, followed by the sauteed mushrooms and onion mixture."},
						{Text: "Using a pastry brush, brush the dough border with the beaten egg to help with browning."},
						{Text: "Bake for 14-16 minutes, or until the puff pastry edges are golden brown."},
						{Text: "Remove from oven and let cool 2-3 minutes. Cut into squares and serve."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat oven to 350°F. Grease a 9 x 13 inch pan."},
						{Text: "Mix all ingredients except chocolate chips at medium speed for 2 minutes."},
						{Text: "Gently fold in chips."},
						{Text: "I always use a 9 x 13 pan, by 2 - 9 inch round pans can also be used. Bake for 30 - 40 minutes until a toothpick inserted in the center comes out clean."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 180°C (or gas mark 4)."},
						{Text: "Clean carrots and arrange in a 22 x 33 centimetre baking dish."},
						{Text: "Using an electric mixer, cream the butter, sugar, salt, and cinnamon. While the mixer is running, slowly add the boiling water and orange juice."},
						{Text: "Pour mixture over the carrots and cover the dish with aluminium foil. Bake for 90 minutes."},
						{Text: "Remove the foil and transfer carrots to a serving platter. Drizzle carrots with the melted cinnamon butter from the baking dish. Garnish with chopped parsley, if desired."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Remove stem and blossom ends from zucchini and dice into 1/4 to 1/2 inch pieces. Measure 2 cups."},
						{Text: "Peel and dice onion. Measure 1 cup."},
						{Text: "Stem and seed peppers, then dice. Measure 1 cup."},
						{Text: "Important, don't skip this step! Combine diced vegetables in a large bowl and sprinkle salt over the top. Stir gently to distribute the salt, then add water until vegetables are completely submerged. Allow the vegetables to soak in the saltwater for 2 hours, then drain completely."},
						{Text: "Prepare a water bath canner (optional, only if canning)."},
						{Text: "In a separate saucepan or stockpot, bring vinegar, sugar, and spices to a gentle simmer (180 degrees F). Do not add salt, the salt is only used to soak veggies before draining."},
						{Text: "Add drained vegetables to the simmering vinegar/spices and gently simmer for 10 minutes."},
						{Text: "Pack hot relish into prepared half-pint or pint jars, leaving 1/2 inch headspace."},
						{Text: "If not canning, just seal jars and allow them to cool on the counter before storing in the refrigerator."},
						{Text: "If canning, de-bubble jars, wipe rims, and adjust headspace to ensure 1/2 inch. Seal with 2 part canning lids."},
						{Text: "Process in a water bath canner for 10 minutes, then turn off the heat. Allow the jars to sit in the canner for another 5 minutes to cool slightly, then remove the jars to cool on a towel on the counter."},
						{Text: "Leave the jars undisturbed for 24 hours, then check seals. Store any unsealed jars in the refrigerator for immediate use. Properly canned and sealed jars should maintain peak quality on the pantry shelf for 12-18 months."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Add the olive oil to a 12-inch skillet/frying pan or large sauté pan (nonstick is definitely best here) and bring to medium-high heat."},
						{Text: "While the oil’s heating, gently crack the eggs into a bowl and whisk until smooth. Set aside."},
						{Text: "Once shimmering and heated, about 3 minutes, add the potato, onion, salt and pepper to the skillet and sauté for 15-20 minutes, stirring every 2-3 minutes until the onion and potato have softened and become golden-brown or even slightly charred in color (the potatoes should look like the color of breakfast hash browns/home fries)."},
						{Text: "Reduce the heat to medium-low. Pour the whisked eggs into the pan with the veggies and oil, top with the cheese and meat (if using either or both) and let it all rest, undisturbed without stirring, for 30-60 seconds. Almost immediately, the egg around the perimeter of the skillet will begin to solidify."},
						{Text: "Gently slide a silicone spatula under the eggs. A firm, yet fluffy bottom layer will have formed, and now it's time to scramble the eggs! Using the spatula (and NEVER a fork), gently swirl the eggs, veggies, cheese and meat around in the pan, folding it all together (aka mixing them with a swirly flip) so the egg clings to the veggies and the cheese begins to melt. This should take about 1-2 minutes total, at most. (NOTE: A Spanish omelette is typically served a little runny. Since this is an homage to that, I like to cook my eggs until they're JUST underdone and slightly runny. However, you can absolutely continue to cook your eggs until they're more well-done, if you desire. The oil in the pan will prevent them from drying out.)"},
						{Text: "Turn off the stove and remove the pan from the heat and serve immediately."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Add chicken to slow cooker and cover with seasoning. Top with cream cheese. Use the back of a spoon to smear the cream cheese over the meat."},
						{Text: "Cover the slow cooker with a lid. Cook on LOW for 6-8 hours or HIGH 3-4 hours."},
						{Text: "Once cooking time finishes, shred the chicken by using two forks and pulling the meat apart. Remove bones if needed. Stir well and thoroughly coat the chicken with sauce."},
						{Text: "Fry bacon in a pan over medium heat on the stove. Remove and chop or crumble into small pieces. Cover the chicken with bacon and shredded cheese. Put the lid back on and continue cooking on HIGH for 15 minutes until cheese melts."},
						{Text: "Remove from heat. Mix bacon and cheese into the chicken or serve as is with them resting on top. Garnish with a tablespoon or two of fresh parsley if desired!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Snijd de kipfilets doormidden en leg de kipfilets op een stuk huishoudfolie."},
						{Text: "Hoe platter de kipfilets zijn hoe beter. Daarom gaan we ze platslaan. Bedek de kipfilets met nog een stuk huishoudfolie en sla ze voorzichtig plat met bijvoorbeeld een koekenpan."},
						{Text: "Verwijder de bovenste laag huishoudfolie en leg de kipfilets tegen elkaar aan."},
						{Text: "Bedek de kip met de prosciutto en bedek weer met een stuk huishoudfolie. Draai het geheel nu om zodat de prosciutto onderop komt te liggen."},
						{Text: "Smeer de kipfilet in met de zuivelspread."},
						{Text: "Maak de gremolata door de peterselie, knoflook, sap van de citroen en de olijfolie met elkaar te blenden in een keukenmachine of hakmolen."},
						{Text: "Verdeel de gremolata nu ook over de kipfilet."},
						{Text: "Rol de kipfilet met de prosciutto aan de buitenkant nu zo strak mogelijk in de folie en leg voor 1 uur in de koelkast."},
						{Text: "Verwarm de oven voor op 150 graden."},
						{Text: "Verwijder het folie van de kiprollade en bindt hem eventueel op met rolladetouw om te voorkomen dat hij uit elkaar valt."},
						{Text: "Leg de kiprollade in een ovenschaal en bak in ongeveer 45 à 60 minuten gaar."},
						{Text: "Snijd de kiprollade in mooie plakken en serveer ze direct."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Obierz ziemniaki, zetrzyj na tarce. Odsącz masę przez sito. Zetrzyj cebulę na tarce."},
						{Text: "Dodaj do ziemniaków cebulę, jajka, gałkę muszkatołową oraz mini kostkę Knorr."},
						{Text: "Wymieszaj wszystko dobrze, dodaj mąkę, aby nadać masie odpowiednią konsystencję."},
						{Text: "Rozgrzej na patelni olej, nakładaj masę łyżką. Smaż placki z obu stron na złoty brąz i od razu podawaj."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Whisk the sauce (coconut aminos, sriracha, maple syrup & sesame oil) together in a large bowl."},
						{Text: "Toss in brussel sprouts and coat mixture evenly over the brussels."},
						{Text: "Roast for 30 minutes."},
						{Text: "Turn oven to broil for 2-3 minutes to crisp (watch carefully to not burn.)"},
						{Text: "Top with everything or sesame seeds."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "1 - Prepare the zucchini."},
						{Text: "2 - Char the green beans."},
						{Text: "3 - Cook the gnocchi."},
						{Text: "4 - Finish the gnocchi."},
						{Text: "5 - Serve."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{Values: []models.HowToStep{
					{Text: "Verwarm de oven voor op 200 ºC. Leg de zalmfilets in een ovenschaal en bestrijk ze met de olie en eventueel wat peper en zout. Bak ze in het midden van de oven gaar in 15 minuten."},
					{Text: "Kook (of stoom) de cashewnoten in een klein laagje water, circa 8 minuten. Giet de cashewnoten af en doe ze met het limoensap, de dille, 60 ml koud water en een snufje zout in de keukenmachine of blender en blendeer tot een romige saus. Voeg eventueel wat meer water toe om te verdunnen."},
					{Text: "Serveer de zalm met krieltjes sperziebonen en cashew-dillesaus."},
				}},
