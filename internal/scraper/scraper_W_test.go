	...
	testcases := []testcase{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a medium pot add rice and water and bring mixture to boil. Then simmer on low heat with cover for 25 mins. Let it cool down completely. Using a fork fluff the rice to separate the grains before using."},
						{Text: "In a large skillet or wok heat oil on medium to high heat."},
						{Text: "Add chopped garlic, ginger and the white portion of scallions (reserve green for garnishing). Cook it for 1-2 mins."},
						{Text: "Then add diced peppers, carrot and peas. Stir fry them for few minutes (see notes)."},
						{Text: "Now add soy sauce, rice vinegar and mix well."},
						{Text: "Finally, add cold rice and mix well with vegetables. Season with salt if necessary."},
						{Text: "Garnish with green onions and serve warm."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a medium bowl, whisk together eggs, 1/8 tsp salt, and 1/8 tsp pepper. Set aside."},
						{Text: "Add 1/2 Tbsp butter to a nonstick 7- or 8-inch nonstick skillet over medium heat."},
						{Text: "Add ham, green pepper, onion, 1/8 tsp salt, and 1/8 tsp pepper to the skillet and cook until veggies are softened and ham is just starting to brown, about 3-5 minutes. Remove to a bowl and set aside."},
						{Text: "With skillet still over medium heat, add remaining 1/2 Tbsp butter and let coat bottom of pan."},
						{Text: "Pour the beaten eggs into the skillet and let them cook undisturbed for a couple minutes until they start to set around the edges."},
						{Text: "Using a spatula, gently push the cooked edges toward the center, tilting the pan to let the uncooked eggs flow to the edges to cook. Continue until there’s no liquid egg left, but the top is still slightly runny. You can gently flip the omelet at this point, but you don&#39;t have to."},
						{Text: "Add cooked veggies and ham to one side of the omelet and sprinkle with shredded cheese."},
						{Text: "Carefully fold the omelet in half, covering the filling and let cook for another minute to melt cheese."},
					},
				},
				Name:      "Western Omelet",
				PrepTime:  "PT10M",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat oven to 425°F. Line a baking sheet with parchment paper. Coat the paper with cooking spray."},
						{Text: "Place the flatbread on the lined baking sheet. Spread the sauce all over flatbread. Top with the mozzarella, pepperoni, and then peppers. Lightly coat top with cooking spray. Sprinkle with the Parmesan."},
						{Text: "Bake 10 to 15 minutes, until edges are golden brown and cheese is melted. Season with crushed red pepper, Italian seasoning, and/or garlic powder, if desired."},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Remove the bowl from the refrigerator and portion the dough into balls of desired size. (I use a cookie scoop to make mine approximately 1 inch in diameter). Enjoy!"},
					},
				},
				Name: "Energy Balls",
				NutritionSchema: &models.NutritionSchema{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Pre-heat oven to 475 degrees F."},
						{Text: "Shape the dough into 2 medium-ish pizzas while on a clean floured surface. Let the dough sit for 5 minutes and then re-form to make sure it's as big as you'd like. Place the pizza dough on a lightly floured rimless baking sheet, or pizza peel."},
						{Text: "Spread the basil vinaigrette over the top of each pizza. Top with the mozzarella, scatter the peas and asparagus on top of the cheese. Transfer to an oven and cook for about 5 minutes. Remove the pizza and add the egg on top of each pizza and transfer them back into the oven to continue to cook until the egg white is set and the yolk still runny ."},
						{Text: "Remove from the oven, Add the prosciutto on top and garnish with basil."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Pre-heat the oven to 180°c. Place the new potatoes in a pan with cold water and season generously with salt."},
						{Text: "Place on a high heat and bring to the boil, once boiling reduce heat to medium and cook for approximately 15-20 minutes until tender, once cooked drain and set aside."},
						{Text: "Place a large, ovenproof, heavy bottomed pan or casserole dish on a high heat and season the chicken generously with salt & pepper."},
						{Text: "Once pan is hot, add the olive oil, lay the chicken pieces in the pan and cook on all sides until golden brown, turning every couple of minutes, this should take 10-15 minutes. Remove the chicken from the pan and set aside on a plate."},
						{Text: "Add the onions, garlic cloves, rosemary, bay leaves & thyme, turn heat to medium and cook for a further 10 minutes until the onions are starting to brown, stir every minute or so. Add the white wine to deglaze the pan and cook for a further 2 minutes to reduce. Add the potatoes and chicken and gently stir to mix the ingredients together."},
						{Text: "Place in the middle shelf of the pre-heated oven for approximately 10-15 minutes to allow the potatoes to lightly brown. Check the chicken is fully cooked with no pink meat and it is steaming hot in the centre."},
						{Text: "Allow to rest for 5 minutes, serve, and enjoy."},
						{Text: "See our Terms of Service."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "1. TO PREPARE THE SALAD:   Using half the cucumber cut in half lengthways and scoop out the seeds with a teaspoon then slice on the diagonal into ½ cm halfmoons. Dice the tomato into 1 cm cubes then thinly slice ½ of the red onion."},
						{Text: "2. TO FINISH THE SALAD:   Place the cucumber, tomato and red onion into a serving bowl along with the crispy noodles and baby leaves. Roughly chop the coriander leaves and stalk then add to the serving bowl. Add half of the Thai dressing and season with salt and pepper and toss before serving."},
						{Text: "3. TO COOK THE BEEF SIRLOIN STEAK:   Remove the marinated beef sirloin steaks from their packaging and pat dry with a paper towel and season with salt and pepper. Heat a drizzle of oil in a non-stick frying pan over a medium-high heat. Once hot cook the beef for 2-3 mins each side for medium-rare – a little longer for well done. Remove from the pan and allow to rest for a few mins before slicing thinly. BBQ Instructions: Heat your BBQ up to a medium heat. Once hot cook beef steaks for 2-3 mins each side. Remove from the BBQ and allow to rest for a few mins before slicing thinly."},
						{Text: "TO SERVE:   Divide salad between plates then top with sliced beef. Drizzle over remaining Thai dressing and sprinkle with roasted peanuts."},
					},
				},
