	...
	testcases := []testcase{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Keywords: &models.Keywords{
					Values: "oven roasted baby potatoes, roasted baby yukon gold potatoes, garlic baby potatoes, roasted baby red potatoes, roasted whole baby potatoes",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
						...
						"1/2 teaspoon garlic powder", "freshly ground black pepper, to taste",
					},
				},
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
