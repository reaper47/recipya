	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Type: "HowToStep", Text: "Blend yoghurt, chili, nellike, spidskommen, kardemomme, garam masala, gurkemeje, ingefær, hvidløg og hakkede tomater sammen til en lind sauce."},
						{Type: "HowToStep", Text: "Hæld den over kyllingestykkerne, dæk dem til og lad dem trække i min. 30 minutter i køleskabet og gerne natten over eller fra morgenstund til aftensmadstid."},
						{Type: "HowToStep", Text: "Smelt smør og olie i en sauterpande. Sautér løgene, til de bliver bløde og blanke."},
						{Type: "HowToStep", Text: "Tilsæt kylling, sauce og fløde."},
						{Type: "HowToStep", Text: "Lad det simre ved lav varme i 30-35 minutter, eller til kyllingen er mør. Server med ris og et drys frisk koriander"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Type: "HowToStep", Text: "Arrange an oven rack in the center of the oven. Preheat the oven to 350F (180C). Place the nuts on a small sheet pan and put them in the oven while the oven is preheating. Toast the nuts for about 15 minutes, or until the nuts are fragrant and starting to turn slightly darker. Chop fine when cool. Set aside."},
						{Type: "HowToStep", Text: "Grease a 9 inch by 5 inch (23 centimeters by 13 centimeters) loaf pan thoroughly on the all sides and bottom. Be sure to get the corners good! Line the pan with parchment paper, just one strip across the bottom and sides will act as a handle to remove the bread once baked. Clip the sides of the parchment to the pan if desired."},
						{Type: "HowToStep", Text: "In a medium mixing bowl, whisk the flour, corn starch, ginger, cinnamon, salt, baking powder, and baking soda. Set aside."},
						{Type: "HowToStep", Text: "In a large mixing bowl, whisk the brown sugar, cane sugar and oil until ingredients are combined, about 30 seconds. Add the eggs, orange zest and juice and vanilla. Whisk until the ingredients are emulsified, about 20 seconds."},
						{Type: "HowToStep", Text: "Add the dry ingredients to the egg/sugar mixture. Using a silicone spatula, gently mix/fold until no flour streaks remain. If using coconut oil, the batter will start to stiffen at this point because the coconut oil is cooling (solidifying). Fold in the yogurt until no white streaks remain.Working quickly, fold in the shredded carrots and nuts. If using canola oil, the batter should be thick but loose and almost pourable (pictured in the photos). For coconut oil, the batter should be stiff and thick."},
						{Type: "HowToStep", Text: "Transfer the cake batter to the loaf pan and using an offset spatula, smooth the batter into an even layer. If using coconut oil, spread the batter while pressing it into the pan. Tap the pan on the counter to disperse any air pockets. Remove the parchment clips if using."},
						{Type: "HowToStep", Text: "Bake the cake for 60-70 minutes. The loaf is ready when it&#039;s golden, a toothpick poked in the center comes out clean, the cake slightly springs back under gentle pressure at center, and the edges of the loaf are just starting to pull away from the sides of the pan. Allow cake to cool in the pan for 20 minutes on a cooling rack. Lift cake out and transfer to a cooking rack. Cool completely at room temperature before icing or covering (about 2 hours)."},
						{Type: "HowToStep", Text: "Start with ingredients at room temperature. Place butter in mixer and beat on high with the paddle attachment until light and fluffy, about three minutes. Scrape down your bowl several times to make sure the butter is getting whipped. Add the cream cheese and beat another minute. Scrape down the bowl."},
						{Type: "HowToStep", Text: "Sift in the powder sugar, add the vanilla, and orange zest then mix on low until incorporated, about 30 seconds. Taste for sweet adjustment and add another tablespoon of powered sugar if desired. To loosen the icing, you can add a few teaspoons of orange juice."},
						{Type: "HowToStep", Text: "Store the icing in a lidded container, in the refrigerator, if not icing the bread after it cools. Bring to room temperature before slathering!"},
						{Type: "HowToStep", Text: "Because cream cheese needs to be refrigerated, consider how/when you&#039;ll share the cake before icing it. An iced cake needs to be consumed, refrigerated or frozen within three hours. An uniced cake can set covered at room temperature for up to three days.Ice the Cake:Once the loaf cake is cool and just before serving, spread the icing evenly over the top of the cake. Slice and share within three hours.Individual Pieces:Once the loaf is cool, slice the loaf and share with a dollop or slather of cream cheese icing. *Uniced carrot cake bread is lovely toasted or warmed, then slathered with cream cheese icing!"},
						{Type: "HowToStep", Text: "Room Temperature: Store an iced loaf cake at room temperature (70F or less) for up to three hours. Afterwards, store the cake in the fridge, covered for up to three days. Before serving, pull the cake from the fridge and rest at room temperature for about 30 minutes to allow the fats to soften. Food safety says cheese should set out for no more than three hours. An uniced loaf cake can be stored covered at room temperature for up to three days."},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Type: "HowToStep", Text: "Forvarm stekeovnen til 175 grader, og kle en form på ca. 20*20 cm med bakepapir."},
						{Type: "HowToStep", Text: "Smelt margarin og peanøttsmør i en liten gryte. Grovhakk sjokoladen."},
						{Type: "HowToStep", Text: "Ha margarin og peanøttsmør over i en bolle. Rør inn brunt og hvitt sukker, yoghurt, vanilje, maisstivelse og bakepulver. Jobb det godt sammen til en helt jevn røre."},
						{Type: "HowToStep", Text: "Ha i hvetemel, og rør det raskt inn. Det er viktig å ikke blande for mye akkurat her. Vend deretter inn den hakka sjokoladen."},
						{Type: "HowToStep", Text: "Ha deigen over i formen, og press den ut slik at den får en jevn overflate. Sett i ovnen og stek i 25-30 minutter."},
						{Type: "HowToStep", Text: "Avkjøl litt før du skjærer opp i serveringsstykker (disse er gode både lune og kalde)."},
					},
				},
				Name:            "Peanøttkake",
				NutritionSchema: &models.NutritionSchema{},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Type: "HowToStep", Text: "Soak cashews in a hot water for 20 to 30 minutes. When the cashews are soaking, you can prep the other ingredients like chopping tomatoes, preparing ginger-garlic paste, slicing paneer etc."},
						{Type: "HowToStep", Text: "Then drain and add the soaked cashews in a blender or mixer-grinder."},
						{Type: "HowToStep", Text: "Add 2 to 3 tablespoons water and blend to a smooth and fine paste without any tiny bits or chunks of cashews."},
						{Type: "HowToStep", Text: "In the same blender add the roughly chopped tomatoes. No need to blanch the tomatoes before blending."},
						{Type: "HowToStep", Text: "Blend to a smooth tomato puree. Set aside. Don’t add any water while blending the tomatoes."},
						{Type: "HowToStep", Text: "Melt butter in a pan on a low heat. Add tej patta and fry for 2 to 3 seconds or till the oil become fragrant."},
						{Type: "HowToStep", Text: "Add ginger-garlic paste and sauté for about 10 to 12 seconds till the raw aroma disappears."},
						{Type: "HowToStep", Text: "Add the tomato puree and stir well. Cook for 5 to 6 minutes stirring a few times."},
						{Type: "HowToStep", Text: "Next add kashmiri red chili powder and stir again. Continue to sauté till the oil starts to leave the sides of the tomato paste. The tomato paste will thicken considerably and will start coming together as one whole lump."},
						{Type: "HowToStep", Text: "Then add cashew paste and stir well. Sauté the cashew paste for a few minutes till the oil begins to leave the sides of the masala paste."},
						{Type: "HowToStep", Text: "The cashew paste will begin to cook fast. Approx 3 to 4 minutes on a low heat. So keep stirring non-stop."},
						{Type: "HowToStep", Text: "Add water and mix very well. Simmer on a low to medium-low heat."},
						{Type: "HowToStep", Text: "The curry will come to a boil."},
						{Type: "HowToStep", Text: "After 2 to 3 minutes of boiling, add ginger julienne. Reserve a few for garnishing. The curry will also begin to thicken."},
						{Type: "HowToStep", Text: "Add julienned ginger and green chillies, salt and sugar and simmer till the curry begins to thicken."},
						{Type: "HowToStep", Text: "After 3 to 4 minutes, add slit green chillies.also add salt as per taste and ½ to 1 teaspoon sugar (optional)."},
						{Type: "HowToStep", Text: "You can vary the sugar quantity from ¼ tsp to 1 teaspoon or more depending on the sourness of the tomatoes. Sugar is optional and you can skip it too. If you add cream, then you will need to add less sugar."},
						{Type: "HowToStep", Text: "Mix very well and simmer for a minute."},
						{Type: "HowToStep", Text: "After the gravy thickens to your desired consistency, then add the paneer cubes and stir gently.I keep the gravy to a medium consistency."},
						{Type: "HowToStep", Text: "After that add crushed kasuri methi (dry fenugreek leaves), garam masala and cream. Gently mix and then switch off the heat."},
						{Type: "HowToStep", Text: "Garnish the curry with coriander leaves and ginger julienne."},
						{Type: "HowToStep", Text: "You can even dot the gravy with some butter or drizzle some cream."},
						{Type: "HowToStep", Text: "Serve Paneer Butter Masala hot with plain naan, garlic naan, roti, paratha or steamed basmati or jeera rice or even peas pulao."},
						{Type: "HowToStep", Text: "Side accompaniments can be an onion-cucumber salad or some pickle. Also serve some lemon wedges by the side."},
					},
				},
