...
func TestScraper_B(t *testing.T) {
	testcases := []testcase{
		...
		{
			name: "bakels.com.au",
			in:   "https://www.bakels.com.au/recipes/damper-using-pettina-scone-mix/",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtType:        &models.SchemaType{Value: "Recipe"},
				Category:      &models.Category{Value: "Bakery, Patisserie"},
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{},
				DateModified:  "2021-05-18T04:24:49+00:00",
				Description:   &models.Description{},
				Keywords:      &models.Keywords{},
				Image:         &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
						"Group 1", "2.000 KG Pettina Scone Mix", "1.000 KG Bakers Flour",
						"0.020 KG Salt", "Group 2", "0.030 KG Bakels Instant Active Dried Yeast",
						"1.700 KG Water (Variable)",
					},
				},
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Text: "1. Place Group 1 in mixing bowl.", Type: "HowToStep"},
						{Text: "2. Blend on low speed for 1 minute.", Type: "HowToStep"},
						{Text: "3. Dissolve yeast in water and add group 2.", Type: "HowToStep"},
						{
							Text: "4. Blend on medium speed until a smooth developed dough is obtained.",
							Type: "HowToStep",
						},
						{Text: "5. Prove for 30 minutes.", Type: "HowToStep"},
						{Text: "6. Bake at 210°C.", Type: "HowToStep"},
					},
				},
				Name:            "Damper (Using Pettina Scone Mix)",
				NutritionSchema: &models.NutritionSchema{},
				ThumbnailURL:    &models.ThumbnailURL{},
				Tools:           &models.Tools{Values: []models.HowToItem{}},
				Yield:           &models.Yield{Value: 1},
				URL:             "https://www.bakels.com.au/recipes/damper-using-pettina-scone-mix/",
				Video:           &models.Videos{},
			},
		},
		{
		...
		{
			name: "barefeetinthekitchen.com",
			in:   "https://barefeetinthekitchen.com/root-beer-ice-cream/",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtType:        &models.SchemaType{Value: "Recipe"},
				Category:      &models.Category{Value: "Dessert"},
				Cuisine:       &models.Cuisine{Value: "American"},
				DatePublished: "2024-07-05T04:30:00+00:00",
				Description: &models.Description{
					Value: "If you&#039;re a fan of root beer floats -and who isn&#039;t?- you&#039;re going to go wild for this Root Beer Ice Cream. This is a summer treat that could fast become a family favorite!",
				},
				Keywords: &models.Keywords{Values: "Root Beer Ice Cream"},
				Image:    &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
						"1½ cups heavy cream (divided)", "1 cup whole milk",
						"½ cup root beer syrup drink mix ((I use the Soda Stream brand.))",
						"¼ teaspoon kosher salt",
					},
				},
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Text: "Combine the cream, milk, root beer syrup, and salt in a large bowl and whisk to combine.", Type: "HowToStep"},
						{Text: "Pour into your ice cream maker and freeze according to the manufacturer&#39;s instructions.", Type: "HowToStep"},
					},
				},
				Name: "Root Beer Ice Cream",
				NutritionSchema: &models.NutritionSchema{
					Calories:       "395",
					Carbohydrates:  "30",
					Cholesterol:    "95",
				...
				TotalTime: "PT5M",
				Yield:     &models.Yield{Value: 6},
				URL:       "https://barefeetinthekitchen.com/root-beer-ice-cream/",
			},
		},
		{
			name: "bbc.co.uk",
			...
			want: models.RecipeSchema{
				...
				CookTime:      "PT2H",
				DateModified:  "2023-07-05T14:32:03.000Z",
				DatePublished: "2020-11-17T09:16:48.000Z",
				Description: &models.Description{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{},
				DateModified:  "2024-10-07T19:57:58+01:00",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				DateCreated:   "2011-05-10T00:00:00.00-06:00",
				Description: &models.Description{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				NutritionSchema: &models.NutritionSchema{
					Calories:      "300",
					Carbohydrates: "60.0488662958771",
					Cholesterol:   "52.445",
					Fat:           "2.32476678639706",
					Fiber:         "5.44774018914959",
					Protein:       "11.4823529627363",
					SaturatedFat:  "0.619135359073004",
					Servings:      "1",
					Sodium:        "50.8475852783613",
					Sugar:         "54.6011261067275",
					TransFat:      "0.476087607733719",
				},
				PrepTime:     "PT30M",
				ThumbnailURL: &models.ThumbnailURL{},
				Tools:        &models.Tools{Values: []models.HowToItem{}},
		...
		{
			name: "breadtopia.com",
			in:   "https://breadtopia.com/kubaneh-jewish-yemeni-bread/",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtType:        &models.SchemaType{Value: "Recipe"},
				...
				Cuisine:       &models.Cuisine{},
				Description: &models.Description{
					Value: "Kubaneh is an amazing Jewish Yemeni pull-apart bread consisting of multilayered rolls laminated with butter and nigella seeds. Both the yeast and sourdough versions are delicious and can be enjoyed at any meal and paired with sweet or savory foods. Traditionally, the bread is baked for Sabbath (Saturday) morning and served with boiled eggs, grated fresh tomatoes, and spicy zhoug sauce.",
				},
				Keywords: &models.Keywords{Values: "Bread,Sourdough,Yeast"},
				Image:    &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
						"Yeast Version", "450g bread flour (scant 3 1/2 cups)", "40g sugar (3 Tbsp)",
						"9g instant yeast (1 Tbsp)", "8g salt (1 1/2 tsp)", "225g water (scant 1 cup)",
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Text: "Sourdough Prep", Type: "HowToStep"},
						{Text: "If you're doing the sourdough version, make the sweet stiff starter the night before you plan to bake. After mixing the ingredients, knead the starter dough a bit on your counter to fully incorporate the ingredients, then place the blob in a jar, press it down with your knuckles and cover loosely. The starter should double (or more) in 8-12 hours, and you can proceed with the rest of the instructions.", Type: "HowToStep"},
						{Text: "Mixing", Type: "HowToStep"},
						{Text: "Pull 57g/half stick of butter from the refrigerator, unwrap it, and place it on a small plate to soften. Fold the wrapper in half and save it to grease your springform pan and countertop. Reminder: The butter doesn't go into the dough during mixing.", Type: "HowToStep"},
						{Text: "Whisk the dry ingredients in a large bowl: flour, sugar, (yeast), and salt.", Type: "HowToStep"},
						{Text: "Add the water, whole egg, egg white, (and sourdough starter broken into pieces). Mix thoroughly until the dough is smooth.", Type: "HowToStep"},
						{Text: "Pour 1 tablespoon of oil on top of the dough, cover, and let the dough rise until it has more than doubled. In a warm summer kitchen, this took 1 hour for the yeast version and 4.5 hours for the sourdough version.", Type: "HowToStep"},
						{Text: "Shaping and Final Proof", Type: "HowToStep"},
						{
							Text: "Smudge a bit of the softened butter onto your saved butter wrapper and grease a 9-inch springform pan. Use this wrapper to lightly grease your countertop too.",
							Type: "HowToStep",
						},
						{
							Text: "Scrape the dough out of the bowl and de-gas it by pressing your palms into it.",
							Type: "HowToStep",
						},
						{
							Text: "Divide the dough in 12-18 pieces. See the photo galleries for different outcomes with fewer large pieces (yeast) versus more smaller pieces (sourdough).",
							Type: "HowToStep",
						},
						{
							Text: "Working one piece at a time, spread the dough thin with butter-coated fingertips. Don't worry if you tear the dough a bit.",
							Type: "HowToStep",
						},
						{
							Text: "Layer more butter on the thin dough, then sprinkle it with nigella seeds. (Have a paper towel nearby to occasionally de-seed your buttery fingers as the seeds will shred the next dough ball.)",
							Type: "HowToStep",
						},
						{
							Text: "Fold the dough in thirds, and then roll it from a short side.",
							Type: "HowToStep",
						},
						{
							Text: "Place the roll in your pan, working from the center outward. It's okay if the rolls topple over a bit. You can adjust them later, and a little chaos adds to the appeal.",
							Type: "HowToStep",
						},
						{
							Text: "When all the rolls are done, cover your pan and let the dough rise until it has more than doubled. This was 1 hour for the yeast version and 2.5 hours for the sourdough version. See the photo gallery for expansion.",
							Type: "HowToStep",
						},
						{Text: "Baking", Type: "HowToStep"},
						{Text: "Preheat your oven to 350F.", Type: "HowToStep"},
						{
							Text: "Beat the egg yolk with a tablespoon of water and brush the top of the dough. Sprinkle with nigella seeds and bake for 30 minutes uncovered.",
							Type: "HowToStep",
						},
						{
							Text: "Let the dough cool on a rack for about 20 minutes before you remove the outer ring of the pan. Serve on the base.",
							Type: "HowToStep",
						},
					},
				},
				Name:            "Kubaneh (Yemenite Jewish Bread)",
				NutritionSchema: &models.NutritionSchema{},
				PrepTime:        "PT1H0M",
				ThumbnailURL:    &models.ThumbnailURL{},
				Tools:           &models.Tools{Values: []models.HowToItem{}},
				...
				URL:             "https://breadtopia.com/kubaneh-jewish-yemeni-bread/",
				Video:           &models.Videos{},
			},
		},
		{
					...
					Values: []models.VideoObject{
						{
							...
							Name:        "Chicken Lollipop / Drums of Heaven",
							ThumbnailURL: &models.ThumbnailURL{
								Value: "https://cdn.prod.website-files.com/60d34b8627f6e735cf28df18/62a95eaacb8d206406f1d296_Chicken%20Lollipop%20Hero%204.3.avif",
							},
						},
					},
				},
		...
		{
			name: "bottomlessgreens.com",
			in:   "https://bottomlessgreens.com/complete-dinners/gluten-free-chicken-marsala",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtType:        &models.SchemaType{Value: "Recipe"},
				Category:      &models.Category{Value: "complete dinners"},
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{},
				DateModified:  "2022-09-21T17:12:41-0400",
				DatePublished: "2022-08-21T17:41:44-0400",
				Description:   &models.Description{Value: "THE absolute BEST gluten free chicken marsala! Creamy and delicious for the whole family. My daughter says this is the best chicken I’ve ever made and continuously asks for it again."},
				Keywords:      &models.Keywords{Values: "complete dinner,easy meal,easy recipe,weeknight meal,kid friendly meal,family meal,family dinner,light cream sauce,mashed potatoes,best chicken marsala,gluten,gluten free,gluten-free,gluten free recipe,gluten free meal,best gluten free marsala,gluten free dinner,chicken marsala,chicken,marsala,quick meal,quick recipe,healthy meal"},
				Image:         &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Type: "HowToStep", Name: "Prep.", Text: "Place the chicken in a gallon sized bag with flours, Half the salt and pepper and toss until evenly coated, set aside. Dice onions, mince garlic, slice mushrooms, Take out the chicken broth, heavy cream, wine and set aside. Fill a stock pot with water, add salt and set on burner at medium high heat and bring to a boil. Chop potatoes."},
						{Type: "HowToStep", Name: "Create.", Text: "In a large non-stick skillet on medium high heat, melt 2 Tbsp of butter and heat until hot. Using tongs, place chicken pieces in single layer on the skillet do not overlap (may need to be done in batches). Cook on each side for 5 min until golden brown on both sides and almost, if not entirely, cooked. Once cooked, transfer the chicken to a plate."},
						{Type: "HowToStep", Name: "Create.", Text: "In the same pan add 2 Tbsp butter. Once melted add onions and garlic and saute until fragrant, about 1-2 minutes. Season lightly with remaining salt and pepper and thyme. Add mushrooms and continue to saute until mushrooms begin to turn a darker brown color, about 2-3 minutes. Add the wine and broth and incorporate well. This is a great time to put the potatoes in the boiling water and set a timer for 15 min. Bring the mixture to a simmer and reduce by about half, about 5-8 min) Once reduced, add 3/4 c of the cream and bring to a simmer again. Reduce heat to medium/medium low and continue to simmer for about 15 minutes, stirring occasionally. During this time your potatoes should be ready. Check with a fork and if it pierces through easily, they are done. Drain and return to pot off the heat. Add the chicken back to the pan and heat for about 5-8 minutes. While chicken is heating add remaining heavy cream and butter to the potatoes and mash well. I like to use my hand mixer for smooth potatoes. Add salt and pepper to taste."},
						{Type: "HowToStep", Name: "Finish.", Text: "Serve on a large plate sprinkle with fresh parsley."},
					},
				},
				Name:            "[Gluten-Free] Chicken Marsala with Mashed Potatoes",
				NutritionSchema: &models.NutritionSchema{},
				ThumbnailURL:    &models.ThumbnailURL{Value: "http://static1.squarespace.com/static/61a14d0dde2c6f4f7fca6594/t/6302a67a412bed746b2dfe3e/1661118078997/IMG_6046%255B1%255D.jpg?format=1500w"},
				Tools: &models.Tools{
					Values: []models.HowToItem{
						{Text: "Stock pot", Quantity: 1, Type: "HowToTool"},
						{Text: "Cutting board", Quantity: 1, Type: "HowToTool"},
						{Text: "Large knife", Quantity: 1, Type: "HowToTool"},
						{Text: "Gallon size plastic bag", Quantity: 1, Type: "HowToTool"},
						{Text: "Tongs", Quantity: 1, Type: "HowToTool"},
						{Text: "Large skillet (5qt+) or dutch oven", Quantity: 1, Type: "HowToTool"},
						{Text: "colander", Quantity: 1, Type: "HowToTool"},
						{Text: "wooden spoon", Quantity: 1, Type: "HowToTool"},
						{Text: "serving spoon", Quantity: 1, Type: "HowToTool"},
					},
				},
				Yield: &models.Yield{Value: 1},
				URL:   "https://bottomlessgreens.com/complete-dinners/gluten-free-chicken-marsala",
				Video: &models.Videos{},
			},
		},
		{
