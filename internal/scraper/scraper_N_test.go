	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Pre-heat oven to 160°C"},
						{Text: "Grease Ninja Foodi Zerostick Medium 20cm square tin and line with parchment paper with a little excess to help lift out the brownies later. Set to one side"},
						{Text: "Place milled flax in small bowl, gradually whisk in the cold water until combined then leave to one side for 5 minutes"},
						{Text: "Add all brownie ingredients except for the milk, food colouring, melted chocolate and coconut oil into a medium bowl and stir until fully combined. Stir in the food colouring into the milk followed by the flax mixture and beat into the dry ingredients. Finally, stir in the melted chocolate and coconut oil until combined"},
						{Text: "Pour mixture into prepared Ninja Foodi Zerostick Medium 20cm square tin. Bake for 15 to 20 minutes in centre of oven. Once baked leave to cool in tin"},
						{Text: "Whilst brownies are baking begin to prepare the worms. Extend all 100 plastic straws, tap down onto a surface and secure with elastic band then carefully place into a pint glass with the bendy ends at the bottom. Set to one side"},
						...
						{Text: "Place all of the ingredients for the frosting into a small blender and blend until smooth. Immediately remove the lid and pour mixture over the brownies"},
						{Text: "Now place all dirt ingredients into a food processor and blend until the mixture becomes the texture of dirt. Evenly sprinkle the dirt over the brownies, reserving a couple of tablespoons for late, and gently pat down to allow the dirt to adhere. Place brownie tin into the refrigerator for 1 to 2 hours until set"},
						{Text: "Once the worms have set, carefully remove straws and push from the end opposite to the bendy side until the worm slides out. Repeat for all straws. You may find some break but don’t worry as you’ll be hiding them within the dirt"},
						{Text: "Remove brownies from the refrigerator and using a hot, damp knife, cut the brownies into 16 squares, wiping the knife between cuts"},
						{Text: "Add the worms to the top of the brownies using your creative flare, then sprinkle over a little dirt to hide any imperfections. Store in an airtight container for 3 to 5 days"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat oven to 350°F. Line an 8×8-inch baking pan with parchment paper."},
						{Text: "In a large bowl, combine tahini, maple syrup, eggs, and vanilla; whisk well to combine. The mixture will thicken quite a bit. Add cocoa powder, baking soda, and salt. Continue to mix until the mixture is smooth."},
						{Text: "Melt the chocolate chips in the microwave for 90 seconds, stopping every 30 seconds to mix (this can also be done on the stovetop). Add the melted chocolate to the batter and mix to combine."},
						{Text: "Transfer mixture to prepared baking pan. Bake for 23 to 25 minutes, or until a toothpick inserted in the center comes out mostly clean. Sprinkle with flaky salt."},
						{Text: "Let brownies cool completely in the pan. Lift parchment to remove the brownies from the pan. Cut into 12-16 squares."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "A langyos víz felébe belemorzsoljuk az élesztőt, elkavarjuk benne, majd hozzáadunk két evőkanál lisztet, és negyed ór\xc3\xa1ig érni hagyjuk a kovászt, amíg habos nem lesz a teteje."},
						{Text: "A liszthez öntjük a kovászt, a maradék vizet és az olívaolajat, majd alaposan összedolgozzuk a tésztát."},
						{Text: "Ha a tészta összeállt, akkor lisztezett deszkára tesszük, és további 10 percig dagasztjuk."},
						{Text: "A tésztát 2-3 részre szedjük (attól függően, mekkora és hány féle pizzát szeretnénk készíteni), majd zsemléket formálunk belőlük, és 45 percig letakarva kelesztjük őket."},
						{Text: "Miután megkeltek a tésztáink, egyenként átgyúrjuk őket, és újabb 45 percig másodszorra is megkelesztjük."},
						{Text: "A kétszer kelt tésztákat kinyújtjuk, megszórjuk a kívánt feltétekkel, és 220-250 fokra előmelegített sütőben barnára sütjük."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Pisk eggene sammen med de andre ingrediensene."},
						{Text: "Ha oljen klar i en liten bolle. Dypp et stykke tørkepapir i oljen og smør pannen grundig."},
						{Text: "Ha litt av eggemassen på den varme pannen og la den stivne (Laget i en firkantet panne)."},
						{Text: "Brett omeletten to ganger, og skyv den over på motsatt side av pannen."},
						{Text: "Hell litt mer eggeblanding i pannen og gjenta prosessen. Tanken er at du ender opp med en rektangulær «omelettrulade», som s\xc3\xa5 kan skjæres i skiver."},
						{Text: "Pynt gjerne med vårløk."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a large skillet, melt butter over medium heat and sauté garlic for 1-2 minutes."},
						{Text: "Add chicken broth, heavy cream, pumpkin, and pasta to the pot and stir to combine. Increase heat to medium-high until it starts to simmer. Stir again and reduce heat to medium-low. Cover and cook for 12-15 minutes, or until pasta is tender."},
						{Text: "Remove from heat and stir in parmesan cheese. Adjust amount of cheese, salt, pepper and nutmeg as needed."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "To make the oatmeal, in a high-speed blender, combine the water, dates, cinnamon, and vanilla. Blend until smooth and pour into a saucepan with the rolled oats. Cook until the oats reach your desired consistency."},
						{Text: "To make the drizzle, combine all of the ingredients into a high-speed blender. Blend until smooth and creamy."},
						{Text: "Divide the oatmeal into bowls, top with the drizzle, and garnish with pecans, as desired."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Bring a pot of salted water to the boil. Start the sauce in the next step, and start cooking the pasta when the water boils."},
						{Text: "Combine garlic and 4 tablespoons of the oil in a small skillet over medium-low heat. Cook the garlic, pressing it into the oil occasionally to release its flavor; it should barely color on both sides. Remove the garlic, and add the remaining oil."},
						{Text: "Fry the eggs gently in the oil, until the whites are just about set and the yolks still quite runny. Drain the pasta, and toss with the eggs and oil, breaking up the whites as you do. (The eggs will finish cooking in the heat of the pasta.) Season to taste, and serve immediately, with cheese if you like."},
					},
				},
