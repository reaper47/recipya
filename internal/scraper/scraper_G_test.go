...
func TestScraper_G(t *testing.T) {
	testcases := []testcase{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Keywords: &models.Keywords{
					Values: "ale,celery salt,christmas,cumin,garlic,jackfruit,miso,mushrooms,paprika,seitan,soy sauce,tofu,wheat gluten",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
						"1 tbs Olive Oil", "1 Onion, peeled & chopped small",
						"5 cloves Garlic, peeled & chopped roughly",
						"7.05 oz/200g Chestnut Mushrooms, roughly chopped",
						"1 & 1/2 cup Vegan Ale or Beer", "3 cups/450g Vital Wheat Gluten",
						"2 tbs Soy Sauce", "3 tbs Brown Sugar",
						"2 tbs Miso Paste",
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Text: "Preheat a large nonstick frying pan over low heat & a little oil followed by the onion, mushrooms & garlic then saute for 5 or so minutes, making sure to get them really golden & caramelized.", Type: "HowToStep"},
						{Text: "Meanwhile, add the rest of the wet ingredients, except the ale to your food processor or blender.", Type: "HowToStep"},
						{Text: "After 5 minutes of cooking the mushroom mixture, deglaze the frying pan with the ale. Let the ale bubble away for 3 minutes, string every now and then.", Type: "HowToStep"},
						{Text: "Add the ale and mushroom mix to your blender and blitz the mixture for a minute or until super smooth & then set aside.", Type: "HowToStep"},
						{Text: "Next to a stand mixer (bread mixer/Kitchenaid), with the dough hook attached – add the jackfruit & vital wheat gluten & turn it on for 10 seconds on low speed to mix together. (alternatively, if you don’t have a mixer, do this in a large mixing bowl with a spatular)", Type: "HowToStep"},
						{Text: "Add the blended wet mixture and then continue to mix on medium speed for 10 minutes. (alternatively, knead firmly by hand for 12 minutes).", Type: "HowToStep"},
						...
						{
							Text: "Wrap the brisket in a layer of greaseproof paper, then 2-3 layers of cling film (plastic wrap) as tightly as possible.",
							Type: "HowToStep",
						},
						{
							Text: "Set the brisket aside, whilst you fill a large saucepan with water (halfway high) & bring it to a boil.",
							Type: "HowToStep",
						},
						{
							Text: "When the water comes to a boil, place your brisket carefully in then turn down the heat to a simmer. Leave the brisket to cook for 3 hours. Make sure the water is never rapidly boiling only ever simmering.",
							Type: "HowToStep",
						},
						{
							Text: "All of the above ideally should be done the day or a couple of days before serving.",
							Type: "HowToStep",
						},
						{
							Text: "After cooking, remove the brisket from the water – it should be firm to the touch.",
							Type: "HowToStep",
						},
						{
							Text: "When it’s cool enough to handle, remove the wrapping.",
							Type: "HowToStep",
						},
						{
							Text: "At this point, you can slice and freeze the brisket or serve it right away.",
							Type: "HowToStep",
						},
						{
							Text: "Before serving prepare your grill, bbq, or a large cast-iron pan placed over medium heat.",
							Type: "HowToStep",
						},
						{
							Text: "Add a little oil to the pan & when it’s hot sear the brisket on all sides for a couple of minutes. Whilst you’re searing, grilling, or BBQing, brush bbq glaze over the top.",
							Type: "HowToStep",
						},
						{
							Text: "I pop the brisket in the oven for 10 minutes if I’m finishing it in the pan. Just to make sure it’s heated right through to the centre.",
							Type: "HowToStep",
						},
				...
				URL:             "https://www.gazoakleychef.com/recipes/vegan-brisket/",
				Video:           &models.Videos{},
			},
		},
		{
		...
		{
			name: "goodeatings.com",
			in:   "https://goodeatings.com/recipes/mains/hot-pink-creamy-beetroot-pasta/",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtType:        &models.SchemaType{Value: "Recipe"},
				Category:      &models.Category{Value: "mains"},
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{},
				DateModified:  "2022-03-15T11:03:55+00:00",
				DatePublished: "2022-02-06T14:10:23+00:00",
				Description: &models.Description{
					Value: "This pasta has a serious wow effect, am I right!? Who knew linguine could be hot pink! Actually it's the beetroot in the creamy cashew sauce that makes it so eye catching and vibrant.",
				},
				Keywords: &models.Keywords{
					Values: "beetroot,cashew,creamy,easy,gluten free,main,main course,main dish,menu,pasta,pink,plant based,quick,valentine's day,vegan,walnuts,winter",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
						"0,75 cup raw cashews", "2 shallots", "2 large garlic cloves",
						"2 tbsp olive oil", "2 medium sized cooked and peeled beetroots",
						"2 tbsp lemon juice", "2 tbsp nutritional yeast", "1 tsp salt",
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Text: "Place the cashews in a bowl and pour boiling water over them until covered. Leave to soak for 15 minutes.", Type: "HowToStep"},
						{Text: "In the meantime put your pasta water on to boil and then follow cooking instructions for your particular linguine (or use spaghetti or fettuccine if you prefer) as and when the water comes to a boil. Make sure to salt the water.", Type: "HowToStep"},
						{Text: "Peel and finely chop the shallots and peel and roughly chop the garlic. Place a saute pan over medium heat with the olive oil. Once warm saute the shallot and garlic until softened and translucent. This will take 3-4 minutes.", Type: "HowToStep"},
						{Text: "Transfer the sauteed shallot and garlic to the jug of a blender. Chop up the cooked beetroot roughly and add that too along with lemon juice, nutritional yeast, salt and black pepper. Finely drain and rinse the soaked cashews and add those too. Pour in the soy milk and blend on high until the ingredients mike a smooth and silky sauce.", Type: "HowToStep"},
						{Text: "Warm another frying pan over medium heat and break the walnuts into it. Dry toast them in the pan until fragrant and golden around the edges. Remove from the heat and transfer to a bowl or plate.", Type: "HowToStep"},
						{Text: "When the pasta is cooked drain it and transfer it back to the pot over low heat. Pour over the sauce and use a pair of tongs to coat the pasta in the sauce. Keep moving the pasta around until it is a good temperature.", Type: "HowToStep"},
						{Text: "Serve in pasta bowls and sprinkle with the toasted walnuts. Also sprinklke over some brazil nut “parmesan” and fresh thyme leaves.", Type: "HowToStep"},
					},
				},
				Name:            "Hot Pink Creamy Beetroot Pasta",
				NutritionSchema: &models.NutritionSchema{},
				ThumbnailURL:    &models.ThumbnailURL{},
				Tools:           &models.Tools{Values: []models.HowToItem{}},
				Yield:           &models.Yield{Value: 4},
				URL:             "https://goodeatings.com/recipes/mains/hot-pink-creamy-beetroot-pasta/",
				Video:           &models.Videos{},
			},
		},
		{
			name: "goodeatings2.com",
			in:   "https://goodeatings.com/recipes/salads/herbed-potato-salad-w-chickpeas-and-sundried-tomato/",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtType:        &models.SchemaType{Value: "Recipe"},
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{
							Text: "Clean and boil the potatoes. Ones cooked through cut into cubes, I like to do this whilst they are still hot for a warm salad.",
							Type: "HowToStep",
						},
						{
							Text: "Whilst potatoes are cooking prepare herbs, tomatoes, apple and onion, mix it all up in a bowl. Dress with lemon juice and olive oil and set aside.",
							Type: "HowToStep",
						},
						{
							Text: "Layer your lettuce leaves or greens in a serving bowl.",
							Type: "HowToStep",
						},
						{
							Text: "Add the cubed potatoes to your salad mix and add more oil if needed. Season with salt and pepper.",
							Type: "HowToStep",
						},
						{
							Text: "Place the mixture on top of your leaves/greens and sprinkle with walnuts.",
							Type: "HowToStep",
						},
						{Text: "Serve!", Type: "HowToStep"},
					},
				},
				Name:            "HERBED POTATO SALAD W. CHICKPEAS AND SUNDRIED TOMATO",
				NutritionSchema: &models.NutritionSchema{},
				PrepTime:        "PT25M",
				ThumbnailURL:    &models.ThumbnailURL{},
				Tools:           &models.Tools{Values: []models.HowToItem{}},
				Yield:           &models.Yield{Value: 4},
				URL:             "https://goodeatings.com/recipes/salads/herbed-potato-salad-w-chickpeas-and-sundried-tomato/",
				Video:           &models.Videos{},
			},
		},
		{
