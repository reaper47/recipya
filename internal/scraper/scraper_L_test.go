	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Préchauffe le four à 165°."},
						{Text: "Commence par fouetter les œufs et le sucre, à l’aide de ton robot ou batteur électrique, pendant 10 minutes : ton mélange doit s’éclaircir et doubler de volume !"},
						{Text: "Ajoute le beurre fondu, la levure, la farine et fouette brièvement."},
						{Text: "Verse le lait et fouette jusqu’à l’obtention d’un mélange homogène."},
						{Text: "Sépare la préparation obtenue dans deux bols."},
						{Text: "Dans un des deux bols, ajoute l’arôme ou la poudre de vanille."},
						{Text: "Fais fondre ton chocolat, au bain-marie ou au micro-ondes et incorpore-le dans le second bol à l’aide d’une maryse."},
						{Text: "Récupère ton moule à cake et beurre-le généreusement."},
						{Text: "Verse, dans le fond de ton moule, la moitié de la pâte à la vanille puis la moitié de celle au chocolat."},
						{Text: "Répète l’opération une deuxième fois."},
						{Text: "Enfourne pendant 45 min."},
						{Text: "Tu peux vérifier la cuisson à l’aide d’un couteau, plante-le au centre de ton cake : ta lame doit ressortir sèche."},
						{Text: "À la sortie du four, laisse tiédir ton cake afin de faciliter son démoulage."},
						{Text: "À manger sans modération !"},
					},
				},
				PrepTime: "PT20M",
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Prepare the spaghetti squash. Cut in half"},
						{Text: "and remove seeds and pulp strands. Rub 1 teaspoon of olive oil into each half of squash and season each half with 1/4 teaspoon each of salt (optional) and pepper. Place each spaghetti squash half face down in a large baking dish and bake for 40 to 60 minutes"},
						{Text: "cook until the middle is tender and pulls apart easily."},
						{Text: "While the spaghetti squash is cooking in a large saucepan"},
						{Text: "saute garlic in remaining olive oil over a medium heat until fragrant. Add Turkey. Season with 1/4 teaspoon of each salt (optional) and pepper"},
						{Text: "and then cook until it has browned."},
						{Text: "Add tomatoes"},
						{Text: "onion powder"},
						{Text: "and 1/2 teaspoon each of basil and oregano. When the sauce starts to bubble"},
						{Text: "reduce heat to a simmer until it has thickened (about 3 to 4 minutes)."},
						{Text: "Combine the ricotta and cottage cheese into a medium bow. Season with crushed red pepper flakes (optional) and the remaining basil"},
						{Text: "oregano"},
						{Text: "salt (optional)"},
						{Text: "and pepper. Lightly mix until combined."},
						{Text: "When spaghetti squash is fully cooked"},
						{Text: "flip it in the baking dish so that it is now skin-side down. Lightly scrape flesh of squash with a fork to create spaghetti-like strands."},
						{Text: "Evenly divide the ricotta and cheese mixture between each squash half. Repeat with the meat sauce. Top each half with 1/2 cup of mozzarella cheese."},
						{Text: "Turn oven to broil"},
						{Text: "and cook for an additional 2 minutes"},
						{Text: "or until cheese is browned and bubbling. Watch that it does not burn due to different oven temperatures. Serve immediately"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Brokkoli putzen und in kleinen Röschen vom Strunk schneiden. Zuckerschoten putzen. Lauchzwiebeln putzen und in ca. 10 cm lange Stücke schneiden."},
						{Text: "Brokkoli, Zuckerschoten und Lauchzwiebeln in reichlich kochendem Salzwasser 2–3 Minuten garen. Herausnehmen und mit kaltem Wasser abspülen. Auf ein Sieb gießen und gut abtropfen lassen."},
						{Text: "Fleisch trocken tupfen und in Würfel (ca. 1,5 x 1,5 cm) schneiden. Öl in einer weiten Pfanne oder einem Wok erhitzen. Fleisch darin, unter Wenden, ca. 3 Minuten kräftig anbraten. Hitze reduzieren und weitere ca. 2 Minuten braten. Gemüse, Sojasoße und Brühe zufügen und 3–4 Minuten dünsten. Dabei gelegentlich wenden."},
						{Text: "Koriander waschen und trocken schütteln und, bis auf einige Blätter zum Garnieren, samt Stiel grob hacken. Sesam und Koriander zur Gemüsepfanne geben und untermischen. Mit Salz und Pfeffer abschmecken und mit Koriander garnieren."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Turn on your instant pot and set it to \"saute\". In a small bowl stir together salt, pepper, garlic powder, onion powder, and smoked paprika. Rub mixture all over the roast to coat all sides."},
						{Text: "Drizzle oil in instant pot, wait about 30 seconds, then use tongs to place roast in the pot. Do not move it for 3-4 minutes until well-seared and browned. Use tongs to turn the roast onto another side for 3-4 minutes, repeating until all sides are browned."},
						{Text: "Switch instant pot to \"pressure cook\" on high and set to 60-80 minutes (60 for a 3 pound roast, 80 for a 5 pound roast. see notes if using baby carrots). Add potatoes, onions, and carrots to pot (just arrange them around the roast) and pour beef broth and worcestershire sauce over everything. Place lid on the pot and turn to locked position. Make sure the vent is set to the sealed position."},
						{Text: "When the cooking time is up, do a natural release for 10 minutes (don't touch anything on the pot, just let it de-pressurize on it's own for 10 minutes). After 10 minutes, turn vent to the venting release position and allow all of the steam to vent and the float valve to drop down before removing the lid."},
						{Text: "Transfer the roast, potatoes, onions, and carrots to a platter and shred the roast with 2 forks into chunks. Use a handheld strainer to scoop out bits from the broth in the pot. Set instant pot to \"soup\" setting. Whisk together the water and corn starch. Once broth is boiling, stir in corn starch mixture until the gravy thickens. Add salt, pepper, and garlic powder to taste."},
						{Text: "Serve gravy poured over roast and veggies and garnish with fresh thyme or parsley if desired."},
					},
				},
		...
		},*/
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Meng de stukjes kip met de tandoori kruiden (dit kunnen droge kruiden zijn of een kruidenpasta) en de yoghurt in een kom. Dek af en laat ondertussen in de koelkast staan."},
						{Text: "Ga verder met het afbakken van de pitabroodjes. Snijd de komkommer in plakjes."},
						{Text: "Maak de saus: hak de munt fijn en rasp de limoen en pers het sap uit. Meng de munt en limoen met de yoghurt voor de saus en breng op smaak met een snufje peper."},
						{Text: "Verhit een beetje olie in een koekenpan en bak de stukjes kip tandoori gaar."},
						{Text: "Neem een pitabroodje en vul deze met plakjes komkommer, de kip tandoori en wat van de frisse yoghurtsaus."},
					},
				},
				Name:      "Pita tandoori",
				PrepTime:  "PT0H30M",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a blender, combine the vanilla ice cream, milk, peppermint extract, crushed peppermint candies (roughly crushed if using a high-speed blender), chocolate chips, and red food coloring (if using)."},
						{Text: "Blend the mixture until it&#39;s smooth and all the ingredients are well combined. You can adjust the milk or ice cream to achieve your desired milkshake consistency."},
						{Text: "Taste the milkshake and adjust the amount of peppermint extract and crushed candies to your liking. Some people prefer a stronger peppermint flavor, while others like it milder."},
						{Text: "Pour the milkshakes into your serving glasses, top them with whipped cream and a maraschino cherry and enjoy."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Ofen auf 220 °C (Umluft) vorheizen. In einem Topf ca. 1 l Salzwasser zugedeckt aufkochen. Schweinefilets waschen, trocken tupfen, in Medaillons schneiden und zum Temperieren beiseitelegen. Kartoffeln gründlich waschen und längs vierteln. Rosmarin waschen, trocken schütteln, Nadeln von den Stielen streifen und sehr fein hacken."},
						{Text: "Kartoffeln in einer Schüssel mit zwei Drittel vom Rosmarin, 1 EL Olivenöl und Salz vermengen. Mit der Hautseite nach unten auf ein Backblech legen und im Ofen ca. 25 Min. rösten."},
						{Text: "Inzwischen Bohnen waschen, trocken tupfen, Enden dünn abschneiden und im kochenden Salzwasser ca. 4 Min. kochen. Bohnen anschließend in ein Sieb abgießen, unter kaltem Wasser abspülen und abtropfen lassen."},
						{Text: "Derweil Schalotten halbieren, schälen und fein würfeln. In einer Pfanne 1 EL Olivenöl auf mittlerer bis hoher Stufe erhitzen, Medaillons salzen und im Öl von jeder Seite ca. 3 Min. anbraten. Fleisch pfeffern und in Alufolie gewickelt bis zum Anrichten durchziehen lassen. Pfanne nicht säubern."},
						{Text: "2 EL Olivenöl und Paniermehl zum Bratensatz in die Pfanne geben und Brösel auf mittlerer Stufe ca. 2 Min. goldgelb rösten. Restlichen Rosmarin und Salz zugeben, kurz mitrösten und auf einem Teller beiseitestellen. Pfanne säubern."},
						{Text: "1 EL Olivenöl in der gesäuberten Pfanne auf mittlerer Stufe erhitzen und Schalotten weitere ca. 2 Min. mitbraten. Abgetropfte Bohnen und 3 EL Butter zugeben, durchmischen, ca. 1 Min. erwärmen und mit Salz und Pfeffer abschmecken. Kartoffeln aus dem Ofen nehmen und mit Schweinemedaillons, Bohnen und Bröseln auf Tellern anrichten und servieren.\r\n\r\nGuten Appetit!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "PREP: Position a rack in the center of the oven and preheat the oven to 350°F. Spray two 8 ½ x 4 ½ (or 9x5) bread pans with cooking spray, you can also line with parchment if you’d like; set aside for now."},
						{Text: "DRY INGREDIENTS: Add the dry ingredients: flour, baking soda baking powder, all the spices, and salt to a medium bowl. Whisk to combine; set aside for now."},
						{Text: "WET INGREDIENTS: Add the granulated sugar, brown sugar, and oil to a large bowl. Whisk to combine, then add the pumpkin puree, eggs, vanilla, and orange zest and combine to whisk until all the eggs have been incorporated into the wet batter. Don't be alarmed if the batter splits or curdles! It's totally fine!"},
						{Text: "BREAD BATTER: Add the dry ingredients into the wet ingredients in two batches, stirring just long enough so each batch of flour is incorporated. Do not over-mix or you’ll end up with dry bread!"},
						{Text: "BAKE: Divide the batter into the to pans, taking care to only fill each pan about ¾ of the way full. The bread will rise significantly! Smooth out the batter then sprinkle with the pepitas. Bake the bread for 52-62 minutes or until a toothpick inserted in the center of the loaf comes out clean. Cool the pans on a wire baking rack for at least 10 minutes before removing from the pan and allowing the bread to cool further."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Prepare fire in the charcoal grill. Remove the grates, place a pile of charcoal on one side of the grill only. On the other side, place a small foil pan filled with water. Start the fire and return the grates to the grill. Let the grill get to a low temperature (about 275°F.) You may also add pieces of wood to the charcoal for a more smoky flavor."},
						{Text: "While the fire is heating, prepare ribs. Turn ribs over so that the bone side is facing up. Remove the membrane along the back by sliding a dull knife (such as a butter knife) under the membrane along the last bone until you get under the membrane. Hold on tight, and pull it until the whole thing is removed from the rack of ribs."},
						{Text: "Rub ribs all over with spice rub. Once fire is ready, place the ribs on indirect heat - the side of the grill that has the foil pan. Cover and cook about 2 hours, watching to make sure the fire is maintained at a steady low temperature, adding charcoal as needed, and rotating the rack of ribs roughly every 30 minutes so that different edges of the rack are turned toward the hot side."},
						{Text: "After 1 1/2 to 2 hours, remove ribs and wrap in foil. Return to the grill for another 30 minutes or so."},
						{Text: "When ribs are done, you can either remove them from the foil and place back on the grill, meat side down, for a little char, or place them meat side up and brush with barbecue sauce in layers, waiting about 5 minutes between layers. Or simply remove them from the grill to a cutting board, slice, and serve!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Verwarm de oven voor op 180 ˚C en bekleed een bakplaat met bakpapier."},
						{Text: "Snijd de bloemkool in kleine roosjes. Leg deze op de met bakpapier beklede bakplaat en schep ze om met 2 eetlepels olie en garam masala. Rooster de roosjes 25-30 minuten in de voorverwarmde oven."},
						{Text: "Kook intussen de rijst volgens de instructies op de verpakking."},
						{Text: "Snijd de ui, de knoflook en de gember fijn. Verwarm 1 eetlepel olie in de pan en fruit hierin de ui, knoflook en gember. Voeg de overige kruiden en de tomatenblokjes toe. Laat 15 minuten sudderen op laag vuur en breng op smaak met zout."},
						{Text: "Voeg de geroosterde bloemkool en de linzen toe aan de saus en laat het nog 10 minuten sudderen."},
						{Text: "Verdeel de rijst over 2 diepe borden en schep de saus ernaast. Maak swirls van kokosyoghurt en ahornsiroop, en voeg eventueel wat gehakte cashewnoten toe voor een extra bite."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Soak the cashews. Place the cashews into a bowl. Pour boiling hot water from the kettle over the top of the cashews to submerge them. Leave the cashews to soak for 1 hour and then drain and rinse."},
						{Text: "Preheat the oven to 375°F (190°C)."},
						{Text: "Add the soaked cashews, lemon juice, coconut cream, distilled white vinegar, salt, onion powder, vegan chicken spice, vegan buffalo sauce and nutritional yeast to the blender and blend until smooth."},
						{Text: "Transfer the blended mix to a mixing bowl."},
						{Text: "Add chopped artichoke hearts and chopped spring onions and gently fold them in."},
						{Text: "Transfer to an oven safe 9-inch round dish and smooth down."},
						{Text: "Bake for 20 minutes until lightly browned on top."},
						{Text: "Serve topped with chopped spring onions with tortilla chips, crackers, breads or veggies for dipping."},
					},
				},
