	...
	testcases := []testcase{
		{
			...
			want: models.RecipeSchema{
				...
				CookTime:      "PT50M",
				Cuisine:       &models.Cuisine{Value: "Thai"},
				DatePublished: "2016-01-25",
				Description: &models.Description{
					Value: "This Thai green chicken curry recipe is a real classic. The Thai green curry paste ingredients are an epic flavour combo that won't disappoint. It's fiery!",
				},
				Keywords: &models.Keywords{
					Values: "mushroom, chicken curry, thai, thai green curry, vegetables, Course, Mains, One-pan recipes, Dish Type, Curry, Main Ingredient, Chicken, Method, Stewing, Occasion, Dinner Party",
				},
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Type: "HowToStep", Text: "To make the curry paste, peel, roughly chop and place the garlic, shallots and ginger into a food processor."},
						{Type: "HowToStep", Text: "Trim the lemongrass, remove the tough outer leaves, then finely chop and add to the processor. Trim and add the chillies along with the cumin and half the coriander (stalks and all). Blitz until finely chopped, add the fish sauce and blitz again."},
						{Type: "HowToStep", Text: "Slice the chicken into 2.5cm strips. Heat 1 tablespoon of oil in a large pan on a medium heat, add the chicken and fry for 5 to 7 minutes, or until just turning golden, then transfer to a plate."},
						{Type: "HowToStep", Text: "Tear the mushrooms into even pieces. Return the pan to a medium heat, add the mushrooms and fry for 4 to 5 minutes, or until golden. Transfer to a plate using a slotted spoon."},
						{Type: "HowToStep", Text: "Reduce the heat to medium-low and add the Thai green paste for 4 to 5 minutes, stirring occasionally."},
						{Type: "HowToStep", Text: "Pour in the coconut milk and 200ml of boiling water, crumble in the stock cube and add the lime leaves. Turn the heat up and bring gently to the boil, then simmer for 10 minutes, or until reduced slightly."},
						{Type: "HowToStep", Text: "Stir in the chicken and mushrooms, reduce the heat to low and cook for a further 5 minutes, or until the chicken is cooked through, adding the mangetout for the final 2 minutes."},
						{Type: "HowToStep", Text: "Season carefully to taste with sea salt and freshly ground black pepper. Pick, roughly chop and stir through the basil leaves and remaining coriander leaves. Serve with lime wedges and steamed rice."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				AtType:        &models.SchemaType{Value: "Recipe"},
				Category:      &models.Category{Value: "Meat"},
				CookTime:      "PT315M",
				CookingMethod: &models.CookingMethod{},
				...
				Keywords:      &models.Keywords{Values: "pork, One-pan wonders, TV Shows, One-pan recipes, Course"},
				Image:         &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						...
						{
							Text: "Peel and halve the onions. Wash, trim and halve the carrots lengthways. Quarter and core the apples. Pick the sage leaves. Lift up the pork and sit the onions, carrots, apples, sage leaves and whole unpeeled garlic bulb underneath the meat.",
							Type: "HowToStep",
						},
						{
							Text: "Roast for 2 hours, then reduce the heat to 150°C/300°F/gas 2 and cook for another 3 hours, or until the meat effortlessly pulls apart, adding splashes of water occasionally to prevent it from drying out, if needed.",
							Type: "HowToStep",
						},
						{
							Text: "Lift off all the crackling and put aside. Remove the pork to a board to rest. Spoon the excess fat off the tray into a jam jar (save for tasty cooking another day), then squeeze the soft garlic cloves out of the skins, and mush up the carrots, onions and apples.",
							Type: "HowToStep",
						},
						{
							Text: "Return the pork to the tray, then shred and pull apart with two forks, removing any gristly bits and bones.",
							Type: "HowToStep",
						},
						{
							Text: "Mix well until beautifully dressed in all the outrageous tray juices, then season to perfection. Snap up the crackling and place back on top, then enjoy as is or hold in the oven until needed. Batch up the extra portions to stash in the fridge or freezer for future meals.",
							Type: "HowToStep",
						},
					},
				},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						...
						{Type: "HowToStep", Text: "Maak in de tussentijd de boemboe door de ingrediënten heel fijn te snijden (ui, knoflook) en samen te voegen met de droge kruiden in de ingrediëntenlijst. Kneus de stengel citroengras. Fruit de boemboe inclusief de stengel citroengras aan in een steelpan met een beetje zonnebloemolie. Voeg na ongeveer 3 minuten kokosmelk en het bouillonblokje toe en laat op laag vuur nog 5 minuten sudderen."},
						{Type: "HowToStep", Text: "Voeg de wortel in de hapjespan met zonnebloemolie. Roerbak ongeveer 5 minuten en voeg dan ook de spitskool toe. Na ongeveer 5 minuten is de spitskool een beetje geslonken, voeg dan ook de bloemkool, sperziebonen, tofu en de boemboe met kokosmelk toe."},
						{Type: "HowToStep", Text: "Verwijder de stengel citroengras. Maak af met limoensap naar smaak."},
					},
				},
