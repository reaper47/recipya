	...
	testcases := []testcase{
		{
			...
			want: models.RecipeSchema{
				...
				Keywords: &models.Keywords{Values: "butter chicken, curry, Indian"},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Description: &models.Description{
					Value: "Knusprige Ofenkartoffeln. Über 262 Bewertungen und für raffiniert befunden. Mit ► Portionsrechner ► Kochbuch ► Video-Tipps! Jetzt entdecken und ausprobieren!",
				},
				Keywords: &models.Keywords{
				...
				Ingredients: &models.Ingredients{
					Values: []string{
						...
						"1 EL Kräuter, italienische , nach Wahl",
					},
				},
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
					...
					Values: []models.VideoObject{
						{
							...
							EmbedURL:    "https://img.chefkoch-cdn.de/ck.de/videos/4244-video.mp4",
							Name:        "Video zu Knusprige Ofenkartoffeln",
							ThumbnailURL: &models.ThumbnailURL{
								Value: "https://img.chefkoch-cdn.de/images/crop-960x540/ck.de/videos/thumbs/4244-org.jpg",
							},
						},
					},
				},
		...
		{
			name: "chetnamakan.co.uk",
			in:   "https://chetnamakan.co.uk/coronation-chicken-sandwich/",
			want: models.RecipeSchema{
				AtContext:     "https://schema.org",
				AtGraph:       nil,
				AtType:        &models.SchemaType{Value: "Recipe"},
				...
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{},
				DateModified:  "2024-06-17T08:13:24+00:00",
				DatePublished: "2024-06-15T17:24:15+00:00",
				Description:   &models.Description{Value: "This classic British sandwich offers a regal blend of tender chicken in a creamy, curry-spiced sauce, balanced with a touch of sweetness, sandwiched between slices of fresh sourdough."},
				Keywords:      &models.Keywords{},
				Image:         &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{
							Text: "Place the chicken breast in a pan and cover in water. Add the cinnamon stick, cardamom pods, and fresh ginger. Bring to a boil and cook for 15 minutes.",
							Type: "HowToStep",
						},
						{
							Text: "Heat 3-4 tbsp olive oil in a pan. Add the onions and cook on medium heat until golden and crispy. Transfer to a sieve placed over a bowl to drain any excess oil.",
							Type: "HowToStep",
						},
						{
							Text: "To prepare the paste, place the mayonnaise, yoghurt, salt, curry powder, chilli, spring onions, and mango chutney in a large bowl. Mix well.",
							Type: "HowToStep",
						},
						{Text: "Shred the chicken and add to the paste. Mix well.", Type: "HowToStep"},
						{
							Text: "Heat 1-2 tbsp oil in a frying pan. Toast all sides of the sourdough until golden and crispy.",
							Type: "HowToStep",
						},
						{
							Text: "Assemble the sandwich by adding the lettuce leaves to the inside of one slice.",
							Type: "HowToStep",
						},
						{
							Text: "Add the chicken filling and drizzle with some chilli oil. Top with the other slice of sourdough.",
							Type: "HowToStep",
						},
				...
				Tools:           &models.Tools{Values: []models.HowToItem{}},
				Yield:           &models.Yield{Value: 1},
				URL:             "https://chetnamakan.co.uk/coronation-chicken-sandwich/",
				Video:           &models.Videos{},
			},
		},
		{
			...
			want: models.RecipeSchema{
				...
				Video: &models.Videos{
					Values: []models.VideoObject{
						{
							AtType:       "VideoObject",
							ContentURL:   "https://content.jwplatform.com/videos/&rdquo;HyLC1Ad5&Prime;.mp4",
							Description:  "”Watch",
							Name:         "”Honey",
							ThumbnailURL: &models.ThumbnailURL{Value: "https://content.jwplatform.com/thumbs/&rdquo;HyLC1Ad5&Prime;-720.jpg"},
							UploadDate:   time.Date(1970, 01, 01, 0, 0, 0, 0, time.UTC),
						},
					},
				},
			},
		},
		{
			...
			want: models.RecipeSchema{
				...
				Category:      &models.Category{Value: "uncategorized"},
				CookingMethod: &models.CookingMethod{},
				Cuisine:       &models.Cuisine{Value: "日本語"},
				DateModified:  "2018-02-19",
				DatePublished: "2018-02-19",
				Description: &models.Description{
					Value: "おうちにある材料で作れるバターチキンカレーです(*´`*)♡ とっても簡単♬すぐ出来るのでぜひお試しください♡ʾʾ",
				},
				Image: &models.Image{Value: anUploadedImage.String()},
				Ingredients: &models.Ingredients{
					Values: []string{
				...
				Keywords:        &models.Keywords{Values: "♥鶏モモ肉,♥玉ねぎ,♥にんにくチューブ,♥生姜チューブ,♥カレー粉,♥バター,＊トマト缶,＊コンソメ,＊塩,＊砂糖,＊水,＊ケチャップ,♥生クリーム"},
				Name:            "30分で簡単♡本格バターチキンカレー♡",
				NutritionSchema: &models.NutritionSchema{},
				ThumbnailURL:    &models.ThumbnailURL{},
				Tools:           &models.Tools{Values: []models.HowToItem{}},
				URL:             "https://cookpad.com/jp/recipes/19600325-30%E5%88%86%E3%81%A7%E7%B0%A1%E5%8D%98%E6%9C%AC%E6%A0%BC%E3%83%90%E3%82%BF%E3%83%BC%E3%83%81%E3%82%AD%E3%83%B3%E3%82%AB%E3%83%AC%E3%83%BC",
				Video:           &models.Videos{},
				Yield:           &models.Yield{Value: 1},
			},
		},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				CookTime:      "PT0S",
				Cuisine:       &models.Cuisine{Value: "American"},
				DatePublished: "2022-03-04T00:01:33.158861-0500",
				Description: &models.Description{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				DateModified:  "2024-05-21T21:28:38.647+02:00",
				...
				Instructions: &models.Instructions{
					Values: []models.HowToItem{
						{Text: "Préchauffez le four à 180°C.", Type: "HowToStep"},
						{
							Text: "Enlevez le pied des champignons de Paris et nettoyez les chapeaux. Epluchez l'échalote et coupez-la en quatre. Coupez le fromage Brie en gros morceaux.",
							Type: "HowToStep",
						},
						{
						...
						{
							Text: "Répartissez la crème dans les champignons et disposez-les sur une plaque du four recouverte de papier sulfurisé. Enfournez pendant 10 à 15 min. Servez immédiatement.",
							Type: "HowToStep",
						},
					},
				},
