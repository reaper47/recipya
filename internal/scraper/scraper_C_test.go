	...
	testcases := []testcase{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "In a bowl, combine chicken with all of the ingredients for the chicken marinade; let marinate for 30 minutes to an hour (or overnight if time allows)."},
						{Text: "Heat oil in a large skillet or pot over medium-high heat. When sizzling, add chicken pieces in batches of two or three, making sure not to crowd the pan. Fry until browned for only 3 minutes on each side. Set aside and keep warm. (You will finish cooking the chicken in the sauce.)"},
						{Text: "Heat butter or ghee in the same pan. Fry the onions until they start to sweat (about 6 minutes) while scraping up any browned bits stuck on the bottom of the pan."},
						{Text: "Add garlic and ginger and sauté for 1 minute until fragrant, then add ground coriander, cumin and garam masala. Let cook for about 20 seconds until fragrant, while stirring occasionally."},
						{Text: "Add crushed tomatoes, chili powder and salt. Let simmer for about 10-15 minutes, stirring occasionally until sauce thickens and becomes a deep brown red colour."},
						{Text: "Remove from heat, scoop mixture into a blender and blend until smooth. You may need to add a couple tablespoons of water to help it blend (up to 1/4 cup). Work in batches depending on the size of your blender."},
						{Text: "Pour the puréed sauce back into the pan. Stir the cream, sugar and crushed kasoori methi (or fenugreek leaves) through the sauce. Add the chicken with juices back into the pan and cook for an additional 8-10 minutes until chicken is cooked through and the sauce is thick and bubbling."},
						{Text: "Garnish with chopped cilantro and serve with fresh, hot garlic butter rice and fresh homemade Naan bread!"},
					},
				},
				Name: "Butter Chicken",
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Die geschälten, geviertelten Kartoffeln gut mit Küchenkrepp abtrocknen. Die Kartoffeln in eine große Schale geben, die Gewürze dazugeben und alles gut mit den Händen durchmengen. Nun das Öl dazugeben und nochmals durchmengen. Die Kartoffeln auf ein Blech geben. Ich fette das Blech nicht noch zusätzlich ein, da das Öl an den Kartoffeln bereits genügt."},
						{Text: "Im vorgeheizten Backofen bei 200 °C Ober-/Unterhitze auf mittlerer Schiene ca. 30 - 40 Min. (je nach Größe der Kartoffelspalten) backen."},
						{Text: "Alle 10 Min. müssen die Spalten gewendet werden, damit sie von allen Seiten schön kross werden. Wenn die Spalten anfangs etwas am Blech festbacken - nicht schlimm, einfach mit einem Pfannenwender lösen."},
						{Text: "Nun aus der sauren Sahne, dem Zitronensaft, den Gewürzen und den Kräutern einen Dip anrühren. Der kann bei Bedarf natürlich auch mit etwas Knoblauch verfeinert werden."},
						{Text: "Dazu gibt es bei uns Fisch oder Hähnchenschenkel."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat oven to 425 degrees. Line a baking sheet with a slipmat or aluminum foil. Top with a wire rack, set aside."},
						{Text: "Dab the chicken wings off with a paper towel to ensure they are completely dry."},
						{Text: "Add the chicken wings to a medium bowl. Sprinkle with baking powder, salt, pepper, garlic powder and onion powder. Toss to coat the chicken wings in the seasonings.Place the chicken wings onto the prepared baking sheet and bake for 45 minutes (depending on the size of the chicken wings)"},
						{Text: "Turn the chicken wings every 20 minutes to ensure they get crispy on both sides."},
						{Text: "Serve the chicken wings as is with ranch dressing or blue cheese for dipping. You could also toss these with your favorite wings sauce or my Honey Chipotle Sauce!"},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Em uma panela e no fogo médio vá adicionando o açúcar aos poucos, mexendo sem parar até derreter completamente;"},
						{Text: "Adicione a água e continue mexendo até dissolver todas as pelotas formadas pelo açúcar;"},
						{Text: "Quando estiver em consistência de calda bem liquida desligue o fogo e aguarde esfriar;"},
						{Text: "Unte os copinhos (50 ml) com um fio de óleo e distribua toda a calda entre eles (cerca de 1 colher de sopa em cada) e reserve."},
						{Text: "Em uma tigela dissolva toda a gelatina incolor na água quente e em seguida reserve;"},
						{Text: "No liquidificador coloque o leite, a essência de baunilha, o creme de leite e o leite condensado;"},
						{Text: "Bata por 2-3 minutos e acrescente a gelatina dissolvida;"},
						{Text: "Bata novamente por mais 1 minuto ou até ficar bem homogêneo;"},
						{Text: "Distribua a mistura entre os copinhos com a calda e para finalizar leve a geladeira por pelo menos 2 horas;"},
						{Text: "Retire da geladeira e pronto, já pode servir."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Combine the shallots, chiles, garlic, ginger, turmeric, galangal, lemongrass, coriander, pepper, lime juice, sugar, salt, and 1 Tbsp vegetable oil in a mortar and pound to a smooth paste with the pestle, or puree in a blender or food processor to a smooth paste."},
						{Text: "Heat 2 Tbsp of oil in a wok or skillet over medium heat. Add the spice paste and saute until fragrant, about 5 minutes. Stir frequently to avoid splattering, and run your fan on high. Remove from pan and let cool. The paste can be made up to a day in advance and refrigerated in an airtight container."},
						{Text: "Trim the roast of excess fat, if any. Using a sharp knife, make a deep slice in the center of roast, starting and ending 3/4 inch from the ends, and cutting almost though to the other side of the roast. You should have a nice pocket about 6 inches long."},
						{Text: "Fill the pocket with spice paste and tie the roast back together with kitchen twine or pin it with metal skewers.  Spread the remaining paste all over the outside of the roast. If any spice mixture remains, set it aside to add during the grilling process."},
						{Text: "If you have a rotisserie, this is probably the best way to cook the roast. Preheat your grill to high and cook for about 1.5 hours."},
						{Text: "I used the indirect cooking method. Move the charcoals to either side of the place where you plan to cook the roast, and place a drip pan in the middle. If you have a gas grill where the coals are not movable, either turn off the middle burner or just put a drip pan made of aluminum foil directly over the center burner. To make a foil drip pan, just tear 3 pieces of foil about 16 inches long, overlap them so they are the width you want, then fold the edges up about 2 inches to form a make-shift drip pan."},
						{Text: "After setting up the grill, preheat it on high. Turn the grill down and place the roast over the drip pan. Adjust heat or coals so the internal temperature rests at about 350 F. This will ensure nice browning without burning, and should result in a cook time of about 2 hours. Turn the meat occasionally during cooking so all sides get equally browned, and rub on additional spice mixture if any."},
						{Text: "Transfer roast to cutting board or platter and let stand for 10 minutes before removing strings and cutting into thin slices to serve."},
					},
				},
				Keywords: &models.Keywords{},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Preheat the oven to 375 degrees Fahrenheit. Place the butter in a large (12-inch) cast iron skillet and place the skillet in the oven to melt the butter, about 5 to 13 minutes (keep an extra eye on it as time goes on—we want it to get bubbly and lightly browned, but not burnt)."},
						{Text: "Meanwhile, in a large bowl, combine the cornmeal, flour, salt, baking powder and baking soda. Stir to combine, and set aside. In a medium bowl, whisk together the eggs and honey until fully blended. Add the milk and whisk until evenly combined."},
						{Text: "Pour the liquid into the dry mixture, and stir just until moistened through (we'll stir it more soon). When the butter is melted and golden, use oven mitts (the skillet is crazy hot!) to remove the skillet from the oven, and give it a gentle swirl to lightly coat about an inch up the sides."},
						{Text: "Pour the melted butter into the batter and stir just until incorporated. Pour the batter back into the hot skillet, using a spatula to scrape all of the batter from the bowl into the skillet."},
						{Text: "Carefully return the skillet to the oven and bake until the bread is brown around the edge, springy to the touch, and a toothpick inserted in the center comes out clean with just a few crumbs, 25 to 30 minutes. Carefully (with oven mitts), place the skillet on a cooling rack. Let it cool for at least 5 minutes before slicing and serving—perhaps with extra butter, honey or jam on the side."},
						{Text: "This cornbread will keep at room temperature in a sealed container for up to 3 days, or up to a week in the refrigerator. You can also freeze it for up to 3 months. Gently reheat before serving."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "鶏モモ肉 は一口大に、 玉ねぎ は薄切り(orみじん切り)にします♪"},
						{Text: "フライパンに バター(大さじ2) を熱し、鶏肉 に 塩胡椒 をふり表面をこんがり焼きます♪"},
						{Text: "お鍋に バター(大さじ3) にんにくチューブ 生姜チューブ 玉ねぎ を入れてあめ色になるまでじっくり炒めます♪"},
						{Text: "カレー粉 を加えて弱火で3分くらい炒めます♪"},
						{Text: "＊ と 鶏肉(油分も) を加えて沸騰したら火が通るまで(10分程)煮ます♪"},
						{Text: "仕上げに 生クリーム を加えて混ぜ、温まったらすぐ火を止めます♪\n完成♡♡\n更に仕上げに生\xe3\x82\xafリームをトッピングしました♡"},
						{Text: "子供ごはんはこんな感じの盛り付けに♡♥"},
					},
				},
				Keywords:        &models.Keywords{},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Split open English Muffins and place them into a toaster, toast the English Muffins."},
						{Text: "In a non-stick skillet over medium heat, cook Candian bacon on both sides for about 1 to 2 minutes in two teaspoons of butter. The bacon should begin to just brown."},
						{Text: "While the Canadian bacon is cooking, remove the English muffins from the toaster and spread softened butter on both halves."},
						{Text: "Place the 1 slice of Canadian bacon on each English Muffin bottom."},
						{Text: "Add about 1 tablespoon of butter to the same skillet where you cooked the bacon."},
						{Text: "Place the quart-sized canning lids screw size up (or you can use an egg ring) into the skillet."},
						{Text: "Spray the canning lid with non-stick spray. Crack an egg into each of the rings."},
						{Text: "Break the yolk with a fork. Pour about 1/2 cup of water into the skillet, and place a lid on top. Cook until the eggs are set, it should take about two minutes."},
						{Text: "Gently remove the eggs from the rings, and place one egg on each piece of Canadian bacon."},
						{Text: "Top each egg with one slice of American cheese, top cheese with the top of the English muffin."},
						{Text: "Wrap each egg McMuffin with foil or parchment paper. Wait about 30 seconds before serving."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "If canning, prepare a water bath canner, jars and lids before beginning. If not canning, no worries, just let it cool on the counter in jars before storing in the refrigerator."},
						{Text: "Heat oil in a heavy-bottomed pan or Dutch oven over medium-high heat, then add the sliced onions and stir to coat."},
						{Text: "Reduce the heat to medium and cook the onions for 45-50 minutes, stirring often."},
						{Text: "Prepare jars and a hot water bath."},
						{Text: "Add maple sugar to the cooked onions and stir to dissolve the sugar."},
						{Text: "Increase the heat to medium-high and cook the onions and sugar for 3-4 minutes, stirring constantly."},
						{Text: "Carefully stir in the vinegar and lemon juice, being cautious of splattering and vinegar vapor."},
						{Text: "Reduce the heat to medium and add salt to the mixture."},
						{Text: "Cook the onion mixture until the vinegar has reduced to a sticky syrup, about 10-12 minutes."},
						{Text: `Pour or ladle the hot jam into prepared hot jars, leaving ½ " headspace at the top of the jars.`},
						{Text: "Wipe the rims of the jars with a clean cloth, and apply the 2-part canning lids."},
						{Text: "Preserve the homemade onion jam using a hot water bath canning method for 10 minutes, adjusting time if necessary for altitude."},
						{Text: "After processing, turn off the heat and leave jars in the canner, uncovered, for 5 minutes. Remove the jars from the canner and let them cool for 12-24 hours, then check that the jars have sealed. Refrigerate any unsealed jars."},
						{Text: "Sealed red onion jam will retain peak quality for up to 18 months stored in a cool, dry place or pantry. Refrigerate the jam once opened."},
					},
				},
				Keywords:        &models.Keywords{},
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						...
						{Text: "Etape 2"},
						{Text: "Enlevez le pied des champignons de Paris et nettoyez les chapeaux."},
						{Text: "Etape 3"},
						{Text: "Epluchez l'échalote et coupez-la en quatre."},
						{Text: "Etape 4"},
						{Text: "Coupez le fromage Brie en gros morceaux."},
						{Text: "Etape 5"},
						{Text: "Dans le bol d'un robot mixeur, placez les morceaux d'échalote et de fromage Brie, la crème fraîche, la tranche de jambon blanc, la chapelure, du sel et du poivre. Mixez jusqu’à obtenir une crème bien lisse et homogène."},
						{Text: "Etape 6"},
						{Text: "Répartissez la crème dans les champignons et disposez-les sur une plaque du four recouverte de papier sulfurisé."},
						{Text: "Etape 7"},
						{Text: "Enfournez pendant 10 à 15 minutes."},
						{Text: "Etape 8"},
						{Text: "Servez immédiatement accompagné de volaille."},
					},
				},
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Instructions: &models.Instructions{
					Values: []models.HowToStep{
						{Text: "Cozinhe as batatas al dente."},
						{Text: "Unte um refratário com azeite e requeijão, coloque as batatas e as cebolas, em cima coloque o peixe temperado com sal e pimenta a gosto, e para finalizar acrescente o requeijão, leve ao forno por Aproximadamente 40 minutos ou até dourar."},
						{Text: "Decore com salsinhas picadinhas"},
						{Text: "Sirva a seguir."},
					},
				},
