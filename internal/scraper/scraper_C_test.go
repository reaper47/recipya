	...
	testcases := []testcase{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Description: &models.Description{
					Value: "Knusprige Ofenkartoffeln. Über 254 Bewertungen und für raffiniert befunden. Mit ► Portionsrechner ► Kochbuch ► Video-Tipps! Jetzt entdecken und ausprobieren!",
				},
				Keywords: &models.Keywords{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				CookTime:      "PT0S",
				Cuisine:       &models.Cuisine{Value: "American"},
				DatePublished: "2022-03-04T00:01:33.158861 EST",
				Description: &models.Description{
