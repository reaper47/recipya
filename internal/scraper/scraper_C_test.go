	...
	testcases := []testcase{
		...
		},
		{
			...
			want: models.RecipeSchema{
				...
				Description: models.Description{
					Value: "Knusprige Ofenkartoffeln. Über 227 Bewertungen und für raffiniert befunden. Mit ► Portionsrechner ► Kochbuch ► Video-Tipps! Jetzt entdecken und ausprobieren!",
				},
