	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			want := []string{
				...
				`<form enctype="multipart/form-data" class="grid max-w-6xl grid-cols-6 m-auto mt-4 pb-4 dark:bg-gray-600 dark:rounded-t-lg" hx-post="/recipes/add/manual" hx-indicator="#fullscreen-loader">`,
