...
func TestHandlers_Recipes_Search(t *testing.T) {
	...
	t.Run("empty query cannot be empty", func(t *testing.T) {
		rr := sendHxRequestAsLoggedIn(srv, http.MethodGet, uri+"?q=&page=0&mode=name", noHeader, nil)
