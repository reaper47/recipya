...
func TestHandlers_Recipes(t *testing.T) {
	...
	t.Run("user has recipes", func(t *testing.T) {
		...
		assertStringsInHTML(t, got, []string{
			...
			`<img class="h-28 w-24 object-cover rounded-t-lg sm:h-40 sm:min-w-full sm:w-full" src="/data/images/placeholder.recipe.webp" alt="Image for the One recipe">`,
			`<img class="h-28 w-24 object-cover rounded-t-lg sm:h-40 sm:min-w-full sm:w-full" src="/data/images/placeholder.recipe.webp" alt="Image for the Two recipe">`,
			`<img class="h-28 w-24 object-cover rounded-t-lg sm:h-40 sm:min-w-full sm:w-full" src="/data/images/placeholder.recipe.webp" alt="Image for the Three recipe">`,
		})
...
func TestHandlers_Recipes_Share(t *testing.T) {
	...
	t.Run("access share link anonymous", func(t *testing.T) {
		...
		assertStringsInHTML(t, body, []string{
			...
			`<img id="output" style="object-fit: cover" alt="Image of the recipe" class="w-full max-h-80 md:max-h-[34rem]" src="/data/images/placeholder.recipe.webp">`,
...
func TestHandlers_Recipes_View(t *testing.T) {
	...
	testcases2 := []struct {
	...
	}{
		{
			...
			videos: nil,
			want: []string{
				`<img style="object-fit: cover" alt="Image of the recipe" class="w-full max-h-80 md:max-h-[34rem]" src="/data/images/placeholder.recipe.webp">`,
			},
		},
		{
