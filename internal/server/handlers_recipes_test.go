	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			want := []string{
				...
				`<form enctype="multipart/form-data" class="grid max-w-6xl grid-cols-6 m-auto mt-4 mb-4 dark:bg-gray-600 dark:rounded-t-lg" hx-post="/recipes/add/manual" hx-indicator="#fullscreen-loader">`,
...
func TestHandlers_Recipes_Share(t *testing.T) {
	...
	t.Run("create valid share link", func(t *testing.T) {
		...
		assertStatus(t, rr.Code, http.StatusOK)
		want := []string{
			`<input type="url" value="example.com/r/33320755-82f9-47e5-bb0a-d1b55cbd3f7b" class="text-input" readonly="readonly">`,
	...
	t.Run("access share link anonymous", func(t *testing.T) {
		...
		want := []string{
			...
			`<a class="p-1 border rounded-lg center hover:bg-gray-800 hover:text-white dark:border-gray-800 print:hidden" href="https://www.allrecipes.com/recipe/10813/best-chocolate-chip-cookies/" target="_blank"> Source </a><p class="hidden print:block print:whitespace-nowrap print:overflow-hidden print:text-ellipsis print:max-w-xs">https://www.allrecipes.com/recipe/10813/best-chocolate-chip-cookies/</p>`,
			...
			`<table class="min-w-full text-xs divide-y divide-gray-200 table-auto dark:text-gray-200 dark:divide-slate-600"><thead class="h-12 font-medium tracking-wider text-white bg-gray-800"><tr><th scope="col" class="text-right"><p class="text-center">Nutrition<br>(per 100g)</p></th><th scope="col" class="text-center"><p>Amount</p></th></tr></thead><tbody class="text-right text-gray-500 bg-white divide-y divide-gray-200 dark:text-gray-200 dark:bg-slate-800 dark:divide-slate-600"><tr><td class="py-2 dark:border-gray-800"><p>Calories:</p></td><td class="text-center dark:border-gray-800"> 500 </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Total carbs:</p></td><td class="text-center dark:border-gray-800"> 7g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Sugars:</p></td><td class="text-center dark:border-gray-800"> 6g </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Protein:</p></td><td class="text-center dark:border-gray-800"> 3g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Total fat:</p></td><td class="text-center dark:border-gray-800"> 8g </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Saturated fat:</p></td><td class="text-center dark:border-gray-800"> 4g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Cholesterol:</p></td><td class="text-center dark:border-gray-800"> 1g </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Sodium:</p></td><td class="text-center dark:border-gray-800"> 5g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Fiber:</p></td><td class="text-center dark:border-gray-800"> 2g </td></tr></tbody></table></div></div></div><div class="col-span-3 border-b border-r border-black md:col-span-1 print:col-span-1"><div class="inline-block min-w-full overflow-x-auto align-middle"><div class="overflow-hidden border-gray-200">`,
			`<table class="min-w-full text-xs divide-y divide-gray-200 dark:text-gray-200 dark:divide-slate-600"><thead class="h-12 font-medium tracking-wider text-white bg-gray-800 border-l dark:border-l-gray-600 print:h-1 print:text-black print:bg-gray-200"><tr><th scope="col" class="text-right">Time</th><th scope="col" class="text-center">h:m:s</th></tr></thead><tbody class="text-right text-gray-500 bg-white divide-y divide-gray-200 dark:text-gray-200 dark:bg-slate-800 dark:divide-slate-600 print:text-gray-700"><tr><td class="py-2">Prep:</td><td class="text-center print:py-0"><time datetime="PT05M">5m</time></td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2">Cooking:</td><td class="w-1/2 text-center print:py-0"><time datetime="PT1H05M">1h05m</time></td></tr><tr class="font-semibold"><td class="py-2">Total:</td><td class="w-1/2 text-center print:py-0"><time datetime="PT1H10M">1h10m</time></td></tr></tbody></table>`,
			`<div class="col-span-6 py-2 border-b border-x border-black md:col-span-2 md:border-r-0 dark:border-gray-800 print:hidden"><h2 class="pb-2 m-auto text-sm font-semibold text-center text-gray-600 underline dark:text-gray-200"> Ingredients </h2><ul class="grid px-6 columns-2"><li class="min-w-full py-2 pl-4 text-sm select-none hover:bg-gray-200 dark:hover:bg-gray-800" _="on mousedown toggle @checked on first <input/> in me"><label for="ingredient-0"></label><input type="checkbox" id="ingredient-0" class="mt-1"><span class="pl-2">Ing1</span></li><li class="min-w-full py-2 pl-4 text-sm select-none hover:bg-gray-200 dark:hover:bg-gray-800" _="on mousedown toggle @checked on first <input/> in me"><label for="ingredient-1"></label><input type="checkbox" id="ingredient-1" class="mt-1"><span class="pl-2">Ing2</span></li><li class="min-w-full py-2 pl-4 text-sm select-none hover:bg-gray-200 dark:hover:bg-gray-800" _="on mousedown toggle @checked on first <input/> in me"><label for="ingredient-2"></label><input type="checkbox" id="ingredient-2" class="mt-1"><span class="pl-2">Ing3</span></li></ul></div><div class="col-span-6 py-2 pb-8 border-b border-x border-black rounded-bl-lg md:rounded-bl-none md:col-span-4 dark:border-gray-800 print:hidden"><h2 class="pb-2 m-auto text-sm font-semibold text-center text-gray-600 underline dark:text-gray-200"> Instructions</h2><ol class="grid px-6 list-decimal"><li class="min-w-full py-2 text-sm select-none hover:bg-gray-200 dark:hover:bg-gray-800" _="on mousedown toggle .line-through"><span class="whitespace-pre-line">Ins1</span></li><li class="min-w-full py-2 text-sm select-none hover:bg-gray-200 dark:hover:bg-gray-800" _="on mousedown toggle .line-through"><span class="whitespace-pre-line">Ins2</span></li><li class="min-w-full py-2 text-sm select-none hover:bg-gray-200 dark:hover:bg-gray-800" _="on mousedown toggle .line-through"><span class="whitespace-pre-line">Ins3</span></li></ol></div></div><div class="hidden print:grid col-span-6 ml-2 mt-2 mb-4"><h1 class="text-sm"><b>Ingredients</b></h1><ol class="col-span-6 w-full" style="column-count: 1"><li class="text-sm"><label><input type="checkbox"></label><span class="pl-2">Ing1</span></li><li class="text-sm"><label><input type="checkbox"></label><span class="pl-2">Ing2</span></li><li class="text-sm"><label><input type="checkbox"></label><span class="pl-2">Ing3</span></li></ol></div><div class="hidden print:grid col-span-5"><h1 class="text-sm"><b>Instructions</b></h1><ol class="col-span-6 list-decimal w-full ml-6" style="column-count: 2; column-gap: 2.5rem"><li><span class="text-sm whitespace-pre-line">Ins1</span></li><li><span class="text-sm whitespace-pre-line">Ins2</span></li><li><span class="text-sm whitespace-pre-line">Ins3</span></li></ol></div>`,
		}
		notWant := []string{
	...
	for _, tc := range testcases {
		t.Run("recipe is in user's collection when "+tc.name, func(t *testing.T) {
			...
			want := []string{
				...
				`<span class="text-sm font-normal leading-none">American</span>`,
				`<div class="grid grid-flow-col"><button class="mr-2" title="Share recipe" hx-post="/recipes/1/share" hx-target="#share-dialog-result" _="on htmx:afterRequest from me if event.detail.successful call #share-dialog.showModal()"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hover:text-red-600" fill="none" viewBox="0 0 24 24" width="24px" height="24px" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.25" fill="currentColor" d="M 18 2 C 16.35499 2 15 3.3549904 15 5 C 15 5.1909529 15.021791 5.3771224 15.056641 5.5585938 L 7.921875 9.7207031 C 7.3985399 9.2778539 6.7320771 9 6 9 C 4.3549904 9 3 10.35499 3 12 C 3 13.64501 4.3549904 15 6 15 C 6.7320771 15 7.3985399 14.722146 7.921875 14.279297 L 15.056641 18.439453 C 15.021555 18.621514 15 18.808386 15 19 C 15 20.64501 16.35499 22 18 22 C 19.64501 22 21 20.64501 21 19 C 21 17.35499 19.64501 16 18 16 C 17.26748 16 16.601593 16.279328 16.078125 16.722656 L 8.9433594 12.558594 C 8.9782095 12.377122 9 12.190953 9 12 C 9 11.809047 8.9782095 11.622878 8.9433594 11.441406 L 16.078125 7.2792969 C 16.60146 7.7221461 17.267923 8 18 8 C 19.64501 8 21 6.6450096 21 5 C 21 3.3549904 19.64501 2 18 2 z M 18 4 C 18.564129 4 19 4.4358706 19 5 C 19 5.5641294 18.564129 6 18 6 C 17.435871 6 17 5.5641294 17 5 C 17 4.4358706 17.435871 4 18 4 z M 6 11 C 6.5641294 11 7 11.435871 7 12 C 7 12.564129 6.5641294 13 6 13 C 5.4358706 13 5 12.564129 5 12 C 5 11.435871 5.4358706 11 6 11 z M 18 18 C 18.564129 18 19 18.435871 19 19 C 19 19.564129 18.564129 20 18 20 C 17.435871 20 17 19.564129 17 19 C 17 18.435871 17.435871 18 18 18 z"/></svg></button><button class="mr-2" onclick="print()" title="Print recipe"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg></button><button class="mr-2" hx-delete="/recipes/1" hx-swap="none" title="Delete recipe" hx-confirm="Are you sure you wish to delete this recipe?" hx-indicator="#fullscreen-loader"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hover:text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button></div></div></div><div class="w-full grid grid-flow-col col-span-6 border-b border-x border-black place-items-center md:border-r-0 md:col-span-4 md:border-b-0 dark:border-gray-800 print:hidden"><img id="output" class="w-full text-center h-96" alt="Image of the recipe" style="object-fit: scale-down" src="/data/images/e81ba735-a4af-4c66-8c17-2f2ccc1b1a95.jpg"></div><div class="grid grid-flow-col col-span-6 border-b border-l border-black md:border-l md:grid-flow-row md:col-span-2 md:grid md:border-r md:border-b-0 dark:border-gray-800 print:border-b"><div class="col-span-2 p-2 border-r border-black md:col-span-3 md:grid md:place-items-center md:border-r-0 dark:border-gray-800"><span class="flex items-center justify-center p-2 font-medium text-blue-700 bg-blue-100 border border-blue-300 rounded-full md:w-1/3 dark:border-gray-800 print:border-none print:text-black print:bg-transparent"><span class="text-sm font-normal leading-none">American</span></span></div><div class="grid col-span-2 py-2 border-black place-items-center text-sm md:col-span-3 md:border-t dark:border-gray-800"><form autocomplete="off" _="on submit halt the event" class="print:hidden"><input id="yield" type="number" min="1" name="yield" value="2" class="w-16 text-center rounded bg-gray-100 p-2 grid self-end dark:bg-gray-900" hx-get="/recipes/1/scale" hx-trigger="input" hx-target="#ingredients-instructions-container"><label for="yield" class="grid self-start">servings</label></form>`,
				`<a class="p-1 border rounded-lg center hover:bg-gray-800 hover:text-white dark:border-gray-800 print:hidden" href="https://www.allrecipes.com/recipe/10813/best-chocolate-chip-cookies/" target="_blank"> Source </a>`,
				`<p class="p-2 text-sm whitespace-pre-line">This is the most delicious recipe!</p>`,
				`<p class="text-xs">Per 100g: 500 calories; total carbohydrates 7g; sugars 6g; protein 3g; total fat 8g; saturated fat 4g; cholesterol 1g; sodium 5g; fiber 2g.</p>`,
				`<table class="min-w-full text-xs divide-y divide-gray-200 table-auto dark:text-gray-200 dark:divide-slate-600"><thead class="h-12 font-medium tracking-wider text-white bg-gray-800"><tr><th scope="col" class="text-right"><p class="text-center">Nutrition<br>(per 100g)</p></th><th scope="col" class="text-center"><p>Amount</p></th></tr></thead><tbody class="text-right text-gray-500 bg-white divide-y divide-gray-200 dark:text-gray-200 dark:bg-slate-800 dark:divide-slate-600"><tr><td class="py-2 dark:border-gray-800"><p>Calories:</p></td><td class="text-center dark:border-gray-800"> 500 </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Total carbs:</p></td><td class="text-center dark:border-gray-800"> 7g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Sugars:</p></td><td class="text-center dark:border-gray-800"> 6g </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Protein:</p></td><td class="text-center dark:border-gray-800"> 3g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Total fat:</p></td><td class="text-center dark:border-gray-800"> 8g </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Saturated fat:</p></td><td class="text-center dark:border-gray-800"> 4g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Cholesterol:</p></td><td class="text-center dark:border-gray-800"> 1g </td></tr><tr class="bg-gray-100 dark:bg-slate-700"><td class="py-2 dark:border-gray-800"><p>Sodium:</p></td><td class="text-center dark:border-gray-800"> 5g </td></tr><tr><td class="py-2 dark:border-gray-800"><p>Fiber:</p></td><td class="text-center dark:border-gray-800"> 2g </td></tr></tbody></table>`,
				`<td class="py-2">Prep:</td><td class="text-center print:py-0"><time datetime="PT05M">5m</time></td></tr><tr class="bg-gray-100 dark:bg-slate-700">`,
